create or replace view v_user_task_list_xk as
select rownum as taskid, t.WFINSTID,t.WFOPTNAME,t.WFOPTTAG,t.NODEINSTID,t.UNITCODE,t.USERCODE,
    ...
    from v_user_task_list t left join opt_base_info e on t.WFINSTID=e.flowinstid,X_PERMIT_APPLY p where t.OPTID =e.optid and p.dj_id = e.dj_id