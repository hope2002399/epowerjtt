...
<body>
	...
	<table cellpadding="0" cellspacing="0" >
		...
		<tr>
			<td>&nbsp;</td>
			<td colspan="5">
			 <a href="userDef!addUserUnderUnit.do?usercode=${usercode}" class="btnA"><span class="btn">添加用户机构</span></a>			
			 <a href="deptManager!bulitUserRole.do?userrole.usercode=${usercode}" class="btnA"><span class="btn">添加用户角色</span></a>
