...
<html>
			...
			<s:form action="userDef" theme="simple">			
				<table cellpadding="0" cellspacing="0" align="center">
					<tr>
						...
						<td><s:textfield name="s_LOGINNAME"  ></s:textfield></td>
					</tr>
					<tr>
						<td class="addTd">所属机构：</td>
						<td>
							<select name="s_byUnderUnit">
	...
	<ec:table action="userDef!listUserInfo.do" items="objList" var="fUserinfo"
			...
			<ec:column property="user"
				title='<button name="quanxuan" target="false" >全选</button><button name="czpw" target="false" >重置密码</button>'
