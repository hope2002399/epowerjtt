...
<html>
	...
	<body>
			...
			<div class="search">
		<div class="crumbs">业务运行记录</div>
			<s:form action="optRunRec" namespace="/sys">
				<table cellpadding="0" cellspacing="0" align="center">
					<tr>
						<td class="addTd"><s:text name="optRunRec.actionurl" />：</td>
						<td><s:textfield name="s_actionurl" /> </td>
						<td class="addTd"><s:text name="optRunRec.funcname" />：</td>
						<td><s:textfield name="s_funcname" /> </td>
					</tr>	

					<tr >
						<td class="addTd"><s:text name="optRunRec.lastreqtime" />：</td>
