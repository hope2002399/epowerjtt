	...
	<body>
		<fieldset style="padding-top:6px;">
			...
			<ec:row>
				...
				<ec:column property="Opt" title='<button name="quanVf" class="btnLittle">重置</button>' sortable="false"
					style="text-align:center">
					<a  href="sys/userDef!resetpwd.do?object.usercode=${fUserinfo.usercode}&norejsp=1" onclick="return confirm('是否重置该用户密码?');">重置</a>
				</ec:column>
			</ec:row>
		</ec:table>
