...
<body class="page-header-fixed" style="background-color:white;">
										...
										<div class="portlet-title">
											...
											全省交通运输行政权力运行情况（按月度统计）<!-- （绿色:<span id="thisyear" ></span>年，蓝色：<span id="lastyear"></span>年） -->
											</span></div>
											<div class="tools">
...
<%--     <script src="<s:url value="/scripts/echarts-plain.js"/>"></script> --%>
	...
	<%-- <script src="${pageContext.request.contextPath}/media/firstpageline.js" type="text/javascript"></script> --%>
