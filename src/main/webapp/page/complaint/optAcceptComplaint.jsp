...
function checkForm(){
	...
	if(trim(_get('promisedate').value).length==0){
		alert("反馈时限不能为空。");
		_get('promisedate').focus();
		return false;
	}
			...
			<table border="0" cellpadding="0" cellspacing="0" id="tb" class="viewTable" style="margin-top: 20px;">
				...
				<tr>
					...
					<td align="left" width="87%">
						...
						<select id="operatorResult"  name="operatorResult">
				...
				<tr>
					<td class="addTd" width="140">投诉反馈时限<font color="red">*</font></td>
					<td align="left"><sj:datepicker id="promisedate"
				name="promisedate" value="%{object.promise_Date}" style="width:120px;"
				timepicker="false" displayFormat="yy-mm-dd" /></td>
				</tr>
