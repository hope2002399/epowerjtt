...
.addTd {
	...
	<div class="search stat">
		<div class="crumbs">申请人为个人证件号码无效的数据</div>
			<form action="。/sys/jttWssbtjsx!showerrorList.do" method="get" >
			<%
...
<div>
	<div>
					<table width="100%" border="0" cellpadding="0" id="treeTable" class="tableRegion" cellspacing="0" class="zn2">
						<caption style="font-size: 16px;padding: 5px;color: #2D80D2;font-weight: bold;">申请人为个人证件号码无效的数据</caption>
						<thead>
							<tr>  
						        <th scope="col" >地区</th>  
						        <th scope="col" >公路</th>
...
<script language="JavaScript"
	...
	function exportExcel(){
		window.location.href = '${pageContext.request.contextPath}/sys/exporterror.do?startTime='+$("#decisionBeginTime").val()+"&endTime="+$("#decisionEndTime").val();
	}
	function openXK(){
		var iWidth=600; //弹出窗口的宽度;
		var iHeight=400; //弹出窗口的高度;
