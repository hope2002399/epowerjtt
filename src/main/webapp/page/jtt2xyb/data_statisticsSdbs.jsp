...
.addTd {
	...
	padding: 10px
		...
		<form action="。/sys/dataStat!sdbs.do" method="get"  id="dataForm" style="margin-top: 0px; margin-bottom: 5px;">
						<%
...
<script type="text/javascript">
	...
	function exportExcel(){
		...
		window.location.href = '${pageContext.request.contextPath}/sys/exportSdbs.do?decisionBeginTime='+decisionBeginTime+'&decisionEndTime='+decisionEndTime;
	}
	function openXK(){
		var iWidth=600; //弹出窗口的宽度;
		var iHeight=400; //弹出窗口的高度;
