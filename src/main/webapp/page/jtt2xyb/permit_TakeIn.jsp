	...
	<s:form action="/sys/importdata.do" namespace="/" id="form1" method="post"  enctype="multipart/form-data" >
		<div align="center">
			...
			<div style="margin-top: 50px;position: relative;">
				...
				<textarea rows="8" id="message" style="width: 450px;height: 150px;margin-left: 2%;"></textarea>
			</div>
			
			<div style="padding-top: 40px;color: red;margin-left: -8%;    font-size: 21px;">
			 	示例模板：<a style="    font-size: 21px;" href="${pageContext.request.contextPath}/UploadFile/XK_Template.xlsx"  >许可模板下载</a>
			</div>
		</div>
	</s:form>
</div>
