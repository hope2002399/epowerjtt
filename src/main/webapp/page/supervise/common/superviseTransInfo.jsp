...
<input type="hidden" id="superviseNo" name="superviseNo"  value="${superviseNo}" />
...
<input type="hidden" id="isOrg" name="isOrg" value="${object.isOrg}">
			...
			<p align="center" style="font-size: 20; color: #01A6E0;">关于对<c:if test="${object.bjType=='1' or (object.bjType=='3' and not empty object.apply.no)}">${object.apply.transactAffairName}办件</c:if><c:if test="${object.bjType=='2' or (object.bjType=='3' and not empty object.punish.no)}">${object.punish.content}处罚</c:if>的督办		
			</p>
			</c:if>
<fieldset style=" display: block; padding: 10px;">
			...
			<c:if test="${moduleParam.hasIdea eq 'T' }">
				...
				<tr>
					<td class="addTd" width="140" id="ideacontent">${moduleParam.ideaContent}<font color="red">*</font></td>
					<td align="left">
