...
<body>
	...
	<fieldset style="border: hidden 1px #000000;">
		...
		<s:form action="superviseBasic" namespace="/supervise"
			...
			<table cellpadding="0" cellspacing="0" align="center">
				<tr>
					<td>督办流水号:&nbsp;&nbsp;&nbsp;<s:textfield name="s_superviseNo"
							id="s_superviseNo" value="%{#parameters['s_superviseNo']}" />
					</td>
					<td>办件流水号:&nbsp;&nbsp;&nbsp;<s:textfield name="s_bjNo"
							id="s_bjNo" value="%{#parameters['s_bjNo']}" />
					</td>
				<tr height="22">
					<td>开始时间:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <sj:datepicker
				...
				<tr>
					...
					<td>
						督办件类别:&nbsp;&nbsp;
						<select name="s_bjType" id="s_bjType">
				...
				<c:if test="${caozuo=='chakan'}">
				<tr>
					<td>督办状态:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select
						name="s_NP_state" id="s_state">
				...
				<tr>
					...
					<td align="right"><s:submit method="listTJ" key="opt.btn.query"
							cssClass="btn" />
	...
	<ec:table action="supervise/superviseBasic!listTJ.do" items="vsuplist"
		var="superviseBasic"
		imagePath="${pageContext.request.contextPath}/themes/css/images/table/*.gif"
		retrieveRowsCallback="limit">
		<ec:row>
			<ec:column property="superviseNo" title="督办流水号"
				style="text-align:center" sortable="true" />
			<ec:column property="bjType" title="督办件类别" style="text-align:center"
				sortable="true">
				${cp:MAPVALUE("bjType",superviseBasic.bjType)}
			</ec:column>
			<c:if test="${superviseBasic.monitorSource ne c }">
			<ec:column property="bjNo" title="办件编号" style="text-align:center"
				sortable="true" />
				</c:if>
			<ec:column property="monitorOrgId" title="被督办部门" style="text-align:center"
				sortable="true">
				${cp:MAPVALUE("unitcode",superviseBasic.monitorOrgId)}&nbsp;
			</ec:column>
			...
			<ec:column property="opt" title="操作" sortable="false"
				...
				<c:if test="${caozuo=='fankui'}">
				<a
					href='supervise/superviseBasic!fankui.do?superviseNo=${superviseBasic.superviseNo}'>反馈</a>
				</c:if>
					<c:if test="${caozuo=='jielun'}">
				<a
					href='supervise/superviseBasic!jielun.do?superviseNo=${superviseBasic.superviseNo}'>结论</a>
				</c:if>
