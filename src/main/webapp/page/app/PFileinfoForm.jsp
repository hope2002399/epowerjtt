...
<s:form action="fileinfo"  namespace="/app" id="PFileinfoForm"  enctype="multipart/form-data">
 	<s:hidden property="method" value="edit" /> 	
 	<s:hidden name="isExist" property="${isExist }"/>
				...
				<tr>
					...
					<td>
						...
						<c:if test="${isExist eq '1' }">
							<a href='<%=request.getContextPath()%>/app/fileinfo!download.do?fileCode=${fileCode}' class="btnA"><span class="btn">查看</span></a>
						</c:if>
					</td>	
				</tr>	
				<tr>
