...
<style type="text/css">
#nodetable td,#nodetable th { padding:5px 10px;height:20px;line-height:20px;border:1px solid #aaa; }
...
<div style='width:100%;overflow:auto;' id="canvas" onmousedown="mouseDown(event)"></div>
...
<div id="NodeView" onclick="closeNodeView()" style="width:800px; border:1px solid #666; background:#fff; position:absolute; left:50%; top:200px; margin-left:-400px;display: none;">
<p id="nodebt" style="padding:6px 0 0 10px;height:24px;line-height:24px;text-align: center;color: red;" >主办人办理</p>
