...
<fieldset style="display: block; padding: 5px;">
		...
		<div class="tabList">
				<div>
					<table border="0" cellspacing="0" cellpadding="0" class="viewTable"
						...
						<c:forEach var="stuff" items="${VOpt}">
							<script type="text/javascript">
	...
	<%-- <ec:table action="powerruntime/generalOperator!listStuffs.do" items="VOpt" var="optIdeaInfo"
			imagePath="${STYLE_PATH}/images/table/*.gif" showPagination="false" showStatusBar="false" showTitle="false" >
			<ec:row>
				<ec:column property="filetype" title="内别" style="text-align:center" sortable="false"/>
				<ec:column property="stuffname" title="名字" style="text-align:center" sortable="false"/>
				<ec:column property="filename" title="文件" style="text-align:center" sortable="false" />
				<ec:column property="nodename" title="节点" style="text-align:center" sortable="false"/>
				<ec:column property="uploadusercode" title="人员" style="text-align:center" sortable="false"/>
			</ec:row>
		</ec:table>
	 --%>
</fieldset>
