			...
			<s:form action="optWritdef" namespace="/powerruntime" style="margin-top:0;margin-bottom:5">
				<table cellpadding="0" cellspacing="0" align="center">
					<tr>
						...
						<td>
							<select name="s_temptype" id="temptypes">
						...
						<td><s:textfield name="s_writcode" value="%{#parameters['s_writcode']}"/> </td>
					</tr>	

					<tr>
						<td class="addTd">文号初始值:</td>
						<td><s:textfield name="s_initvalue" value="%{#parameters['s_initvalue']}"/>
						</td>
			...
			<ec:row>
				...
				<ec:column property="opt" title="操作" sortable="false"
					...
					<a href='powerruntime/optWritdef!delete.do?writid=${optWritdef.writid}' 
							onclick='return confirm("${deletecofirm}:${optWritdef.writcode}?");'>删除</a>
				</ec:column>
