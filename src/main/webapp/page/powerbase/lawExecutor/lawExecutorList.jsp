			...
			<s:form action="lawExecutor" namespace="/powerbase" style="margin-top:0;margin-bottom:5">
				<table cellpadding="0" cellspacing="0" align="center">
					...
					<td class="addTd" align="right">证书编号：</td>
						...
						<td>
							<select id="s_staffstatus" name="s_staffstatus" style="width: 160px">
								<option value="">---请选择---</option>
						...
						<td>
							<select id="s_status" name="s_status" style="width: 160px">
								<option value="">---请选择---</option>
						...
						<s:submit method="list"  key="opt.btn.query" cssClass="btn"/>
							<input type="button" class="btn" name="reset" value="重置" onclick="resetForm();"/></td>
					</tr>
				</table>
			</s:form>
		</div>
