			...
			<s:form action="lawExecutor" namespace="/powerbase" style="margin-top:0;margin-bottom:5">
				<table cellpadding="0" cellspacing="0" align="center">
					...
					<tr>
						...
						<td><s:textfield name="s_staffname" id="s_staffname" value="%{#parameters.s_staffname}"/></td>
					...
					<td class="addTd" align="right">证书编号：</td>
						<td><s:textfield name="s_passcode" id="s_passcode" value="%{#parameters.s_passcode}"/></td>
						<td class="addTd" align="right">审核状态：</td>
						<td>
							<select id="s_auditIdeaCode" name="s_auditIdeaCode" style="width: 160px">
						...
						<s:submit method="listRegister"  key="opt.btn.query" cssClass="btn"/>
							<%-- <s:reset value="重置" cssClass="btn"></s:reset> --%><input type="button" class="btn" name="reset" value="重置" onclick="resetForm();"/>
							<input type="button" value="登记" class="btn" onclick="window.location = 'lawExecutor!built.do?backurl=${backurl}'"></td>
