...
<body>
	...
	<s:form action="powerOrgInfo" method="post" namespace="/powerbase"
		...
		<s:submit name="save" method="saveOrg" cssClass="btn"
			key="opt.btn.save" />
		...
		<fieldset style="padding: 10px; display: block; margin-bottom: 10px;">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="viewTable">
				...
				<tr>
					...
					<td align="left"><input type="hidden" id="unitcode"
						name="retValue" value="" /> <s:textarea name="uninName"
							id="uninName" cols="40" rows="2" style="width:70%;height:40px;"
							value="" /> <input type="button" class='btn' name="powerBtn"
				...
				<tr>
					<td class="addTd" width="130">流程名称</td>
