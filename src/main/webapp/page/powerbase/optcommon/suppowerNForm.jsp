			...
			<table border="0" cellpadding="0" cellspacing="0" class="viewTable">
				...
				<tr>
					<td class="addTd" width="130"><s:text
							name="suppower.outItemId" /></td>
					<td align="left" colspan="3"><s:textfield name="outItemId"
							size="40" value="%{object.outItemId}" /></td>
				...
				<tr>
					...
					<td align="left"><input type="text" id="orgName"
						name="orgName" value="${cp:MAPVALUE('depno',object.orgId)}" /> <input
						type="hidden" id="orgId" name="orgId" value="${object.orgId}" /> <span
						style="color: red">*</span></td>
				...
				<tr>
					...
					<td align="left"><input type="text" id="orgName1"
						name="orgName1" value="${cp:MAPVALUE('depno',object.qlDepid)}" />
						<input type="hidden" id="qlDepid" name="qlDepid"
						value="${object.qlDepid}" /> <span style="color: red">*</span></td>
					<td class="addTd" width="130"><s:text
				...
				<tr>
					...
					<td align="left" colspan="3"><s:radio name="hasItem"
							value="%{object.hasItem}" list="#{'1':'是','0':'否'}" listKey="key"
							listValue="value" /></td>
				</tr>
				<tr>
					<td class="addTd" width="130"><s:text
				...
				<tr>
					<td class="addTd" width="130"><s:text
							name="suppower.acceptCondition" /></td>
					<td align="left" colspan="3"><input type="button"
						...
						<table width="95%" id="table_b1" cellspacing="0" cellpadding="0">
							<tbody class="detailItemBody5" id="detailItemBody4">
								...
								<tr style="display: none">
									<td><textarea style="width: 90%;" id="stand_id"
											name="stand_id"></textarea></td>
								...
								<c:forEach items="${list3 }" varStatus="i" var="process">
									<tr>
										<td><textarea style="width: 90%;" id="stand_id"
												name="stand_id">${process.stand_id } </textarea></td>
										<td><textarea style="width: 90%;" id="stand_code"
												name="stand_code">${process.stand_code }</textarea></td>
					...
					<td align="left" colspan="3"><input type="button"
						...
						<table width="95%" id="table_b1" cellspacing="0" cellpadding="0">
							<tbody class="detailItemBody1" id="detailItemBody2">
								...
								<tr style="display: none">
									<td><input type="text" id="seq_base_lowmul"
										name="seq_base_lowmul" /></td>
									<td><input type="text" id="seq_base_topmul"
										name="seq_base_topmul" /></td>
									<td><textarea style="width: 90%;" id="lastmodyfidate"
											name="lastmodyfidate"></textarea></td>
									<td><textarea style="width: 90%;" id="seq_base_unit"
											name="seq_base_unit"></textarea></td>
									<td><input type="button"
								...
								<c:forEach items="${list1 }" varStatus="i" var="process">
									<tr>
										<td><input style="width: 90%;" id="seq_base_lowmul"
											name="seq_base_lowmul" value="${process.seq_base_lowmul }" /></td>
										<td><textarea style="width: 90%;" id="seq_base_topmul"
												name="seq_base_topmul">${process.seq_base_topmul }</textarea></td>
										<td><textarea style="width: 90%" id="lastmodyfidate"
												name="lastmodyfidate">${process.lastmodyfidate }</textarea></td>
										<td><input style="width: 90%;" type="text"
											id="seq_base_unit" name="seq_base_unit"
				...
				<tr id="punishClass_tr">
					...
					<td align="left" colspan="3" width="80%"><s:textarea
							...
							id="punishClass" value="%{object.punishClass}" readonly="true" />
						<input type="hidden" id="dis_standard" name="dis_standard" /> <input
				...
				<tr id="freeJudge_tr">
					...
					<td align="left" colspan="3" width="80%"><s:textarea
							...
							id="freeJudge" value="%{object.freeJudge}" readonly="true" /> <input
				...
				<tr>
					...
					<td align="left" colspan="3"><s:textarea name="inFlowInfo"
							cols="40" rows="2" id="inFlowInfo"
							style="width:600px;height:70px;" value="%{object.inFlowXml}" />
						&nbsp;<input id="flowedit" type="button" value="编辑" class="btn"
						onclick="editFlow();" /></td>
				</tr>
				<tr>
					<td class="addTd" width="130"><s:text
...
$("#lists span").live('click',function(){
	var $this = $(this);
	bindEvent($("#orgName1"),$("#qlDepid"),$this);
	$("#lists span").die("click");
});
});
</script>
