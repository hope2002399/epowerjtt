	...
	<body>
		...
		<div class="search">
			...
			<s:form action="lawsuit" namespace="/powerbase" style="margin-top:0;margin-bottom:5">
				...
				<tr>
					<td width="30%" align="right">诉讼单位：</td>
					<td>
				...
				<td>
					...
					<tr height="22">
						<td align="right">诉讼时间：</td>
						<td><sj:datepicker name="s_beginlawsuitdate" readonly="true"
								value="%{#parameters['s_beginlawsuitdate']}" yearRange="2010:2030"
								displayFormat="yy-mm-dd" changeYear="true" style="width:200px"/>&nbsp;&nbsp;至&nbsp;&nbsp;<sj:datepicker name="s_endlawsuitdate" readonly="true"
		...
		<ec:table action="powerbase/lawsuit!List.do" items="Lawsuitlist" var="Lawsuit" 
			...
			<ec:row>
				...
				<ec:column property="lawsuitdate" title="诉讼时间" style="text-align:center">
					<fmt:formatDate value="${Lawsuit.lawsuitdate}" pattern="yyyy-MM-dd HH:mm:ss"/>	
				</ec:column>
				...
				<ec:column property="opt" title="操作" style="text-align:center" sortable="false">
					...
					<a href='powerbase/lawsuit!delete.do?lawsuitno=${Lawsuit.lawsuitno}&flag=${flag}' onclick='return confirm("是否删除当前行政诉讼?");'>删除</a>
					</c:if>
					<c:if test="${flag==2}">
