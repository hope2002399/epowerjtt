...
<script language="JavaScript" src="./lhgdialog/lhgcore.min.js"
	type="text/JavaScript"></script>
<script language="JavaScript" src="./lhgdialog/lhgdialog.js"
	type="text/JavaScript"></script>

<style type="text/css">
.arrow {
	background: transparent url(./images/del.gif) no-repeat scroll 0px 0px;
	float: right;
	width: 2%;
	height: 18px;
...
document.getElementById ("item_id ").value =item_id.value ; document.getElementById 
	("version ").value =version.value ; document.getElementById ("dis_detail
	").value =dis_detail.value ; window.onload =function () {openflow ();
...
<body>
	<s:form action="supPower" method="post" namespace="/powerbase"
		...
		<input type="button" name="" class="btn" onclick="CopyTable()"
			value="添加">
		<p>
		<div id="dispay">
			<table width="95%" id="oTable" cellspacing="0" cellpadding="0"
				class="table_b" style="DISPLAY: none">
				<tr class="b_title">
					<td colspan="10">
						<div
							style="float: left; width: 5%; height: 18px; border-right: 0px solid #0000FF; border-top: 0px solid #0000FF; border-bottom: 0px solid #0000FF; margin: 0 auto; line-height: 23px">
							<input type="button"
								onclick="addOrderRow('detailItemBody',2,11,this,'add')"
								value="增加" class="btn" id="btnAdd1" name="btnAdd" />
						</div>
						<div
							style="float: left; width: 25%; height: 18px; border-right: 0px solid #0000FF; border-top: 0px solid #0000FF; border-bottom: 0px solid #0000FF; margin: 0 auto; line-height: 23px">
							自由裁量编号：<input type="text" type="text" class="input_out"
								...
								onmouseout="this.className='input_out'" value="" name="stand_id"
								size="15"> <input type="hidden" value="1"
								name="isNewStand"> <input type="hidden"
								name="standIdbtn" value="detailItemBody">
						</div>
						<div
							style="float: left; width: 68%; height: 18px; border-right: 0px solid #0000FF; border-top: 0px solid #0000FF; border-bottom: 0px solid #0000FF;">
							自由裁量名称：<input type="text" type="text" class="input_out"
								onfocus="this.className='input_on';this.onmouseout=''"
								onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
								onmousemove="this.className='input_move'"
								onmouseout="this.className='input_out'" size="55" value=""
								name="stand_code">
						</div>
				...
				<tbody id="detailItemBody">
					...
					<tr>
						<td>1</td>
						<td><select name="seq_id" style="width: 180px">
						...
						<td><select name="seq_type" style="width: 180px">
								<option value="">--裁量基准--</option>
								<c:forEach var="row" items="${cp:DICTIONARY('seq_type')}">
									<option value="${row.key}">
										<c:out value="${row.value}" />
									</option>
								</c:forEach>
						</select></td>
						<td><input type="text" class="input_out"
							onfocus="this.className='input_on';this.onmouseout=''"
							onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
							onmousemove="this.className='input_move'"
							onmouseout="this.className='input_out'" value="" size="5"
							name="eq_toplimit">&nbsp; <input type="text"
							class="input_out"
							onfocus="this.className='input_on';this.onmouseout=''"
							onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
							onmousemove="this.className='input_move'"
							onmouseout="this.className='input_out'" value="" size="5"
							name="seq_toplimit_unit"></td>
						<td><input type="text" class="input_out"
							onfocus="this.className='input_on';this.onmouseout=''"
							onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
							onmousemove="this.className='input_move'"
							onmouseout="this.className='input_out'" value="" size="5"
							name="seq_lowlimit">&nbsp; <input type="text"
							class="input_out"
							onfocus="this.className='input_on';this.onmouseout=''"
							onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
							onmousemove="this.className='input_move'"
							onmouseout="this.className='input_out'" value="" size="5"
							name="seq_lowlimit_unit"></td>
						<td><input type="text" class="input_out"
							onfocus="this.className='input_on';this.onmouseout=''"
							onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
							onmousemove="this.className='input_move'"
							onmouseout="this.className='input_out'" size="8"
							name="seq_base_name" value=""></td>
						<td><input type="text" class="input_out"
							onfocus="this.className='input_on';this.onmouseout=''"
							onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
							onmousemove="this.className='input_move'"
							onmouseout="this.className='input_out'" size="10"
							name="seq_base_topmul" value=""></td>
						<td><input type="text" class="input_out"
							onfocus="this.className='input_on';this.onmouseout=''"
							onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
							onmousemove="this.className='input_move'"
							onmouseout="this.className='input_out'" size="10"
							name="seq_base_lowmul" value=""></td>
						<td><input type="text" class="input_out"
							onfocus="this.className='input_on';this.onmouseout=''"
							onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
							onmousemove="this.className='input_move'"
							onmouseout="this.className='input_out'" value="" size="5"
							name="seq_base_unit"></td>
						<td><input type="button"
							onclick="addOrderRow('detailItemBody',2,11,this,'delete')"
							value="删除" class="btn" id="btnDelete" name="btnDelete" /> <input
							type="hidden" name="buttable" value="detailItemBody"> <input
							type="hidden" name="butadd" value=""> <input
							type="hidden" name="zycNo" value=""></td>
					</tr>
				</tbody>
			</table>
		</div>
				...
				<tr class="b_title" valign="middle">
					<td colspan="10" width="100%" valign="middle">
						<div
							style="float: left; width: 5%; height: 18px; border-right: 0px solid #0000FF; border-top: 0px solid #0000FF; border-bottom: 0px solid #0000FF; margin: 0 auto; line-height: 23px">
							<input type="button"
								onclick="addOrderRow('detailItemBody<%=i+1 %>',2,11,this,'add')"
								value="增加" class="btn" id="btnAdd1" name="btnAdd" />
						</div>
						<div
							style="float: left; width: 25%; height: 18px; border-right: 0px solid #0000FF; border-top: 0px solid #0000FF; border-bottom: 0px solid #0000FF; margin: 0 auto; line-height: 23px">
							自由裁量编号：<%=zyc.getStandardNo()%><input type="hidden"
								value="<%=zyc.getStandardNo()%>" name="stand_id"
								readonly="readonly" class="byte"> <input type="hidden"
								value="0" name="isNewStand">
						</div>
						<div
							style="float: left; width: 68%; height: 18px; border-right: 0px solid #0000FF; border-top: 0px solid #0000FF; border-bottom: 0px solid #0000FF;">
							自由裁量名称：<input type="text" class="input_out"
								onfocus="this.className='input_on';this.onmouseout=''"
								onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
								onmousemove="this.className='input_move'"
								onmouseout="this.className='input_out'" size="55"
								value="<%=zyc.getPunishfactgrade()%>" name="stand_code"><input
								type="hidden" name="standIdbtn" value="detailItemBody<%=i+1%>">
						</div>
						<div class="arrow" onclick="deleteElement(this)"></div>
    ...
    %>
			...
			if(list2.size() > 0){
				for(int j = 0; j < list2.size(); j++){
		            ...
		            request.setAttribute("punishtypeid", zycview.getPunishtypeid());
		            request.setAttribute("punishtype", zycview.getPunishtype());
        ...
        %>
				<tr>
					...
					<td><select name="seq_id" style="width: 180px">
							...
							<c:forEach var="row" items="${cp:DICTIONARY('punishType')}">
								<option value="${row.key}"
									<c:if test="${punishtypeid eq row.key}"> selected = "selected" </c:if>>
									<c:out value="${row.value}" />
								</option>
							</c:forEach>
					</select></td>
					<td><select name="seq_type" style="width: 180px">
							...
							<c:forEach var="row" items="${cp:DICTIONARY('seq_type')}">
								<option value="${row.key}"
									<c:if test="${punishtype eq row.key}"> selected = "selected" </c:if>>
									<c:out value="${row.value}" />
								</option>
							</c:forEach>
					</select></td>
					<td><input type="text" class="input_out"
						...
						value="<%=(zycview.getToplimit())==null?"":zycview.getToplimit()%>"
						size="5" name="eq_toplimit">&nbsp; <input type="text"
						class="input_out"
						onfocus="this.className='input_on';this.onmouseout=''"
						onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
						onmousemove="this.className='input_move'"
						onmouseout="this.className='input_out'"
						value="<%=zycview.getToplimitUnit()==null?"":zycview.getToplimitUnit() %>"
						size="5" name="seq_toplimit_unit"></td>
					<td><input type="text" class="input_out"
						onfocus="this.className='input_on';this.onmouseout=''"
						onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
						onmousemove="this.className='input_move'"
						onmouseout="this.className='input_out'"
						value="<%=(zycview.getLowlimit())==null?"":zycview.getLowlimit()%>"
						size="5" name="seq_lowlimit">&nbsp; <input type="text"
						class="input_out"
						onfocus="this.className='input_on';this.onmouseout=''"
						onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
						onmousemove="this.className='input_move'"
						onmouseout="this.className='input_out'"
						value="<%=zycview.getLowlimitUnit()==null?"":zycview.getLowlimitUnit() %>"
						size="5" name="seq_lowlimit_unit"></td>
					<td><input type="text" class="input_out"
						onfocus="this.className='input_on';this.onmouseout=''"
						onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
						onmousemove="this.className='input_move'"
						onmouseout="this.className='input_out'"
						value="<%=(zycview.getBaseName())==null?"":zycview.getBaseName()%>"
						size="8" name="seq_base_name"></td>
					<td><input type="text" class="input_out"
						onfocus="this.className='input_on';this.onmouseout=''"
						onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
						onmousemove="this.className='input_move'"
						onmouseout="this.className='input_out'"
						value="<%=(zycview.getBaseToplimit())==null?"":zycview.getBaseToplimit()%>"
						size="10" name="seq_base_topmul"></td>
					<td><input type="text" class="input_out"
						onfocus="this.className='input_on';this.onmouseout=''"
						onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
						onmousemove="this.className='input_move'"
						onmouseout="this.className='input_out'"
						value="<%=(zycview.getBaseLowlimit())==null?"":zycview.getBaseLowlimit() %>"
						size="10" name="seq_base_lowmul"></td>
					<td><input type="text" class="input_out"
						onfocus="this.className='input_on';this.onmouseout=''"
						onblur="this.className='input_off';this.onmouseout=function(){this.className='input_out'};"
						onmousemove="this.className='input_move'"
						onmouseout="this.className='input_out'"
						value="<%=zycview.getBaseUnit()==null?"":zycview.getBaseUnit() %>"
						size="5" name="seq_base_unit"></td>
					<td><input type="button"
						onclick="addOrderRow('detailItemBody<%=i+1 %>',2,11,this,'delete')"
						value="删除" class="btn" id="btnDelete" name="btnDelete" /> <input
						type="hidden" name="zycNo" value="<%=zycview.getStandardNo()%>">
						<input type="hidden" name="buttable"
						value="detailItemBody<%=i+1%>"></td>
				</tr>
				<%}%>
				<%}} %>
			</tbody>
...
%>
			...
			<tr class="b_title">
				<td colspan="10">
					<div
						style="float: left; width: 5%; height: 18px; border-right: 0px solid #0000FF; border-top: 0px solid #0000FF; border-bottom: 0px solid #0000FF; margin: 0 auto; line-height: 23px">
						<input type="button"
							onclick="addOrderRow('detailItemBody1',2,11,this,'add')"
							value="增加" class="btn" id="btnAdd1" name="btnAdd" />
					</div>
					<div
						style="float: left; width: 25%; height: 18px; border-right: 0px solid #0000FF; border-top: 0px solid #0000FF; border-bottom: 0px solid #0000FF; margin: 0 auto; line-height: 23px">
						自由裁量编号：<input type="text" type="text" class="input_out"
							...
							onmouseout="this.className='input_out'" value="" name="stand_id"
							size="15"> <input type="hidden" value="1"
							name="isNewStand"> <input type="hidden" name="standIdbtn"
							value="detailItemBody1">
					</div>
					<div
						style="float: left; width: 68%; height: 18px; border-right: 0px solid #0000FF; border-top: 0px solid #0000FF; border-bottom: 0px solid #0000FF;">
						自由裁量名称：<input type="text" type="text" class="input_out"
			...
			<tbody id="detailItemBody1">
				...
				<tr>
					...
					<td><input type="button"
						...
						value="删除" class="btn" id="btnDelete" name="btnDelete" /> <input
						type="hidden" name="buttable" value="detailItemBody1"> <input
						type="hidden" name="butadd" value=""> <input type="hidden"
						name="zycNo" value=""></td>
				</tr>
			</tbody>
		</table>
		...
		<br>
		<div align="center">
			<input type="button" name="" onclick="btn_doSave();" value="保存"
				class="btn">
		</div>
	</s:form>
</body>
...
function btn_doSave(){
 ...
 var item_id = document.forms[0].item_id.value;standIdbtn
 ...
 var seq_id=encodeURI(encodeURI(conventToString('seq_id')));
 var seq_type=encodeURI(encodeURI(conventToString('seq_type'))); 
 var eq_toplimit=encodeURI(encodeURI(conventToString('eq_toplimit')));
 var seq_lowlimit=encodeURI(encodeURI(conventToString('seq_lowlimit')));
 var seq_toplimit_unit=encodeURI(encodeURI(conventToString('seq_toplimit_unit')));
 var seq_lowlimit_unit=encodeURI(encodeURI(conventToString('seq_lowlimit_unit')));
 var seq_base_topmul=encodeURI(encodeURI(conventToString('seq_base_topmul')));
 var seq_base_lowmul=encodeURI(encodeURI(conventToString('seq_base_lowmul')));
 var seq_base_unit=encodeURI(encodeURI(conventToString('seq_base_unit')));
 var stand_id=encodeURI(encodeURI(conventToString('stand_id')));
 var stand_code=encodeURI(encodeURI(conventToString('stand_code')));
 var buttable=encodeURI(encodeURI(conventToString('buttable')));
 var standIdbtn=encodeURI(encodeURI(conventToString('standIdbtn')));
 var seq_base_name=encodeURI(encodeURI(conventToString('seq_base_name')));
