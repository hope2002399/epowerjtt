	...
	<s:form action="dataenterprise" method="post" namespace="/powerbase"
		...
		<table border="0" cellpadding="0" cellspacing="0" class="viewTable">
			<tr>
				...
				<td align="left"><s:textfield name="applicant" size="40" validator="input" min="10" errorshow="请输入组织机构名称" /><span
			...
			<tr>
				...
				<td align="left"><s:textfield name="applicantPaperNumber"
						size="40" validator="input" min="4" errorshow="请输入组织机构证件号码" /><span
					style="color: red">*</span></td>
			</tr>
