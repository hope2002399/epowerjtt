		...
		<s:form action="supervisorypersonnel" method="post" namespace="/monitor" id="supervisorypersonnelForm" enctype="multipart/form-data">
			...
			<input type="button" class="btn" value="返回" onclick="javascript:history.go(-1);" />
				...
				<tr>
					...
					<td align="left"><s:textfield name="userName" id="userName" value="%{object.userName}" /></td>
					<td class="addTd" width="20%"><span style="color: red">*</span><s:text name="supervisorypersonnel.userId" /></td>
					<td align="left"> <s:textfield name="userId" id="userId" value="%{object.userId}" /></td>
			</tr>
			<tr>
					<td class="addTd" width="130"><span style="color: red">*</span>部门名称</td>
					<td colspan=3 align="left" ><input type="text" id="orgName" name="orgName" style="width:58%;height:25px;" value="${cp:MAPVALUE('unitcode',param.deptcode)}"/>
				...
				<sj:datepicker id="birth" name="birth"  style="width:140px" readonly="true"
			      yearRange="1949:2020"  displayFormat="yy-mm-dd" changeYear="true"  
			    value="%{object.birth}"/>
		       </td>
				...
				<tr>
					...
					<td align="left"><select name="politicalLandscape" id="politicalLandscape">
				...
				<td class="left" ><s:textfield name="tel" id="tel" value="%{object.tel}" /></td>
				...
				<tr>
					...
					<td align="left"><select name="organization" id="organization">
							<option value="">--请选择--</option>
					...
					<td align="left"><select name="updateType" id="updateType" >
							<option value="">--请选择--</option>
