...
<div class="search">
		<div class="crumbs">发文待办</div>
			
			<s:form action="ioDocTasks" namespace="/dispatchdoc" method="post">
				<table cellpadding="0" cellspacing="0" align="left">
					<tr >
					    <td class="addTd">办件编号：</td>
						<td width="180"><s:textfield id="s_flowOptTag" name="s_flowOptTag" value="%{#parameters['s_flowOptTag']}" /> </td>
						<td class="addTd">办件名称：</td>
						<td width="180"><s:textfield id="s_flowOptName" name="s_flowOptName" value="%{#parameters['s_flowOptName']}" /></td>
						<td align="center"><s:submit method="listDispatchDocTasks" key="opt.btn.query" cssClass="btn"/>&nbsp;</td>
					</tr>	
                 </table>
             </s:form>
          </div>
