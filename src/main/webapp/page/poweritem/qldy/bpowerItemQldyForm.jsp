		...
		<legend class="ctitle" style="width: auto; margin-bottom: 5px;">
			...
			<s:form action="bpowerItem" namespace="/poweritem" style="margin-top:0;margin-bottom:5">
				...
				<tr>
						...
						<td align="left" colspan="3"><input type="text" name="itemMainId" id="itemMainId" value="${qldy.itemMainId }" readonly style="width:360px"/></td>
						
					</tr>
				<tr>
						<td class="addTd"><span style="color: red">*</span>主项名称</td>
						<td align="left" colspan="3">
						<input type="text" name="itemMainName" id="itemMainName" value="${qldy.itemMainName }" readonly style="width:360px"/>
						</td>
					
					</tr>
					<tr>
						<td class="addTd"><span style="color: red">*</span>子项编码</td>
						<td align="left" colspan="3"><input type="text" name="itemSubId" id="itemSubId" value="${qldy.itemSubId }" readonly style="width:360px"/></td>
						
					</tr>
				<tr>
						<td class="addTd"><span style="color: red">*</span>子项名称</td>
						<td align="left" colspan="3">
						<input type="text" name="itemSubName" id="itemSubName" value="${qldy.itemSubName }" readonly  style="width:360px"/>
						</td>
				...
				<tr>
						...
						<td align="left" colspan="3"><input type="text" name="serviceId" id="serviceId" value="${qldy.serviceId }" readonly  style="width:360px"/></td>
				...
				<tr>
					...
					<tr>
						...
						<td align="left" colspan="3">
						<input type="text" name="itemQldyItemId" id="itemQldyItemId" value="${qldy.itemQldyItemId }" readonly onchange="checkqldyitemid();" style="width:360px"/>
						<%-- <input
...
function checkqldyitemid(){
	...
	$.ajax({
		type:"POST",
		url: "<%=request.getContextPath()%>/poweritem/bpowerItem!checkItemQldyItemId.do?itemQldyItemId="+itemQldyItemId+"&serviceId="+serviceId,
		contentType:"text/html",					
		dataType:"json",
		processData:false,
		async: false,
