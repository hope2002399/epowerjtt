		...
		<legend class="ctitle" style="width: auto; margin-bottom: 5px;">
			...
			<s:form action="bpowerItem" namespace="/poweritem" style="margin-top:0;margin-bottom:5">
				...
				<tr>
						...
						<td align="left" colspan="3"><input type="text" name="parentId" id="parentId" value="${object.parentId }" readonly style="width:360px"/></td>
						
					</tr>
				<tr>
						<td class="addTd"><span style="color: red">*</span>主项名称</td>
						<td align="left" colspan="3">
						<input type="text" name="parentName" id="parentName" value="${object.parentName }" readonly style="width:360px"/>
						</td>
				...
				<tr>
						...
						<td align="left" colspan="3"><input type="text" name="itemId" id="itemId" value="${object.itemId }" readonly style="width:360px"/></td>
						
					</tr>
				<tr>
						<td class="addTd"><span style="color: red">*</span>事项名称</td>
						<td align="left" colspan="3">
						<input type="text" name="itemName" id="itemName" value="${object.itemName }"  style="width:360px"/>
					...
					<tr>
						...
						<td align="left" >
							<select name="isContainSub" id="isContainSub" style="width: 180px" onchange="changeItemType();">
								<option value="1" <c:if test="${object.isContainSub eq '1'}"> selected = "selected" </c:if>>
									是
								</option>
								<option value="2" <c:if test="${object.isContainSub eq '2'}"> selected = "selected" </c:if> >
									否
								</option>
...
function checkqldyitemid(){
	...
	$.ajax({
		type:"POST",
		url: "<%=request.getContextPath()%>/poweritem/bpowerItem!checkItemQldyItemId.do?itemQldyItemId="+itemQldyItemId+"&itemId="+itemId,
