...
<legend><b>权力事项变更记录</b></legend>
		<ec:table action="poweritem/bpowerItemService!listVersion.do" items="versionList" var="suppowerchglog" imagePath="${STYLE_PATH}/images/table/*.gif" showPagination="false" showStatusBar="false" showTitle="false">
			<ec:row>
   ...
   <table border="0" cellpadding="0" cellspacing="0" class="viewTable">
   	<tr class="b_darkblue">
	    	...
	    	<c:forEach items="${suppowerList }" varStatus="i" var="suppowerInfo" >
	    	 ...
	    	 <tr class="b_gray">
	   <td style="text-align:center"><a href='bpowerItemService!listVersion.do?itemId=${ suppowerInfo.itemId}&version=${ suppowerInfo.version}'>
...
<legend><b>权力事项详细信息</b></legend>
	<table border="0" cellpadding="0" cellspacing="0" class="viewTable">
				...
				<tr>
					...
					<td align="left" colspan="3">${sup.bpowerItemId}</td>
					
				</tr>
				<tr>
					<td class="addTd" width="130">权力实施事项名称</td>
					<td align="left" colspan="3">${sup.bpowerItemName}</td>
			...
			<%-- <tr>
				...
				<tr>
					...
					href='bpowerItemService!downloadStuff.do?itemId=${sup.itemId}&version=${sup.version}&fileType=srvDirectoryStuff_'>
			...
			<tr>
				...
				<td align="left" colspan="3"><a
					href='bpowerItemService!downloadStuff.do?itemId=${sup.itemId}&version=${sup.version}&fileType=applyForm_'>
						${sup.formName}
				</a></td>
			</tr>
			...
			<tr>
					...
					<td align="left" colspan="3"><a
					href='bpowerItemService!downloadStuff.do?itemId=${sup.itemId}&version=${sup.version}&fileType=applyFormDemo_'>
			...
			<tr>
				...
				<a
					href='bpowerItemService!downloadStuff.do?itemId=${sup.itemId}&version=${sup.version}&fileType=inFlowImg_'>
						${sup.inFlowImgName}
				</a></td>
			</tr>
			<tr>
				...
				<td align="left" colspan="3">
				<a href='bpowerItemService!downloadStuff.do?itemId=${sup.itemId}&version=${sup.version}&fileType=processDesc_'>
						${sup.fileName}
				</a></td>
			</tr>
			<tr>
