...
<html>
	...
	<body>
		...
		<ec:table action="poweritem/bpowerItemService!listSupPowerSH.do" items="bpowerItemServicelist" var="SupPowerWithoutLob" 
		          imagePath="${pageContext.request.contextPath}/themes/css/images/table/*.gif" retrieveRowsCallback="limit">
			<ec:row>
				<ec:column property="itemId" title="权力编码" style="text-align:center">
				<a href="<%=request.getContextPath()%>/poweritem/bpowerItemService!suppowerQlbgShEdit.do?itemId=${SupPowerWithoutLob.itemId}&version=${SupPowerWithoutLob.version}">${SupPowerWithoutLob.itemId}</a>
				</ec:column>
