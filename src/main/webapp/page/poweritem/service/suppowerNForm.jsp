		...
		<input type="hidden" id="version" name="version"  value="${param.version}" /> 
			<table border="0" cellpadding="0" cellspacing="0" class="viewTable">
				...
				<tr>
					...
					<td align="left">
					<input type="text" id="orgName1" name="orgName1"  value="${cp:MAPVALUE('depno',object.qlDepid)}"/>
					<input type="hidden" id="qlDepid" name="qlDepid" value="${object.qlDepid}"/>
					<span style="color: red">*</span></td>
				...
				<tr>
					...
					<td align="left" colspan="3"><s:textfield name="acceptTimeScope"
				...
				<tr>
					...
					<td align="left"><s:radio name="ischarge"
							...
							listKey="key" listValue="value" /></td>
				   <td class="addTd" width="130"><s:text name="suppower.itemClass" /></td>
