...
<body>
	...
	<fieldset style="padding: 10px;">
		...
		<s:form action="bpowerItemService" method="post" namespace="/poweritem" id="suppowerchglogForm" enctype="multipart/form-data">
			...
			<tr>
				...
				<td >${cp:MAPVALUE("ITEM_TYPE_NEW",suppowerqlbgsq.itemType)}</td>
				</tr>
				<tr>
