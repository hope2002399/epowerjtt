...
<body
	...
	<fieldset style="padding: 10px;">
		...
		<s:form action="bpowerItemService" method="post" namespace="/poweritem"
			...
			<s:submit name="save" method="suppowerchglogSave" cssClass="btn"  onclick="return checkInput();"
				key="opt.btn.save" />
			...
			<tr>
					<td class="addTd" width="130">权力实施事项编码</td>
					<td align="left" colspan="3"><input type="text" name="bpowerItemId" size="40"
							value="${object.bpowerItemId}" readonly /></td>
					
				</tr>
				<tr>
					<td class="addTd" width="130">权力实施事项名称</td>
					<td align="left" colspan="3"><input type="text" name="bpowerItemName" size="40"
							value="${object.bpowerItemName}" readonly /></td>
				...
				<tr>
					...
					<td align="left"><c:if
							...
							<input type="text" name="itemId" id="itemId" size="40" value="${object.itemId}" onchange="checkitemid();"/>
				...
				<tr>
					...
					<td align="left" colspan="3"><input type="text" name="itemName" id="itemName"
				...
				<tr>
					...
					<td align="left"><select name="orgId" id="orgId" >
					...
					<td align="left"><select name="itemType" style="width: 180px"
						onchange="checkItemType();" id="itemType">
							<option value="">--请选择--</option>
				...
				<tr>
					...
					<td align="left"><input type="text" name="acceptDepname" size="40" id="acceptDepname"
							value="${object.acceptDepname}" /><span style="color: red">*</span></td>
					<td class="addTd" width="130"><s:text
							name="suppower.compatibleType" /></td>
					<td align="left"><%-- <s:radio name="compatibleType"
							list="#{'1':'个人','2':'机构'}" value="%{object.compatibleType}"
							listKey="key" listValue="value" /> --%>
							<input type="radio" name="compatibleType" value="1" <c:if test="${object.compatibleType eq '1'}">checked</c:if>  />个人
							&nbsp;&nbsp;<input type="radio" name="compatibleType" value="2" <c:if test="${object.compatibleType eq '2'}">checked</c:if> />机构
							</td>
				</tr>
				<tr>
					<td class="addTd" width="130"><s:text
				...
				<tr>
					...
					<td align="left"><input name="phone" size="40" id="phone" type="text"
							value="${object.phone}" /> <span style="color: red">*</span></td>
					<td class="addTd" width="130"><s:text
							name="suppower.monitorPhone" /></td>
					<td align="left"><input type="text" name="monitorPhone" id="monitorPhone" size="40"
							value="${object.monitorPhone}" /> <span style="color: red">*</span></td>
				</tr>
				...
				<tr>
					...
					<td align="left" colspan="3"><input type="text" name="address" id="address"
							size="60" value="${object.address}" /> <span style="color: red">*</span></td>
				</tr>
				<tr>
					<td class="addTd" width="130"><s:text
				...
				<tr>
					<td class="addTd" width="130">主要监管措施</td>
					<td align="left" colspan="3"><s:textarea
				...
				<tr id="punishbasiscontent_tr">
					...
					<td align="left" colspan="3"><s:textarea name="xwAccording"
							cols="40" rows="2" style="width:100%;height:40px;"
							value="%{object.xwAccording}" /></td>
				</tr>
				...
				<tr id="levyUpon_tr">
					<td class="addTd" width="130">征收标准</td>
				...
				<tr>
					<td class="addTd" width="130">最后更新时间</td>
	...
	<script type="text/javascript">
		function checkVersion() {
			...
			form.action = "bpowerItemService!SuppowerQlbgSqXg.do";
			form.submit();
		}
		...
		function downFile(id, fileType) {
			var url = "bpowerItemService!downloadStuff.do?itemId=" + id + "&fileType="
					+ fileType;
			document.location.href = url;
		}

		/* function deleteFile(id, fileType) {
			var url = "bpowerItemService!deleteStuff.do?itemId=" + id + "&fileType="
					+ fileType;
			document.location.href = url;
		} */
		function deleteFile(id,v, fileType) {
			var url = "bpowerItemService!deleteStuff.do?itemId=" + id +"&version="+v+ "&fileType="
					+ fileType;
			document.location.href = url;
		}
		function showZycl(item_id, version){

		    var url='bpowerItemService!viewzycl.do?itemId='+item_id+"&version="+version;
		...
		function showZyclstand(item_id, version){
		    ...
		    var url='bpowerItemService!viewcfcx.do?itemId='+item_id+"&version="+version;
		    openNewWindow(url); 
		}
	...
	function checkInput(){
			...
			if(! (/^\d{34}$/.test($("#itemId").val())) ){
				alert("权力编码不正确，应为34位数字");
				return false;
			}
			if($("#itemName").val()==''){
				alert("权力名称不可为空");
	...
	function editFlow(){
		if($.browser.msie&&parseFloat($.browser.version)<9)
			{
		    var url = '${pageContext.request.contextPath}/page/powerbase/innerflow/vml/vmlEdit.html';		
			}
		else
			{
