...
<table class="viewTable" cellpadding="0" cellspacing="0">		
  <tr>
    ...
    <td><label>
    <c:if test="${not empty object.flowCode}"><s:textfield name="object.flowCode" value="%{object.flowCode}" readonly="true" style="width:140px;" /></c:if>
    <c:if test="${empty object.flowCode}"> <s:textfield id="flowCode" name="object.flowCode" style="width:140px;" /></c:if>
    </label></td>
   </tr>
    <tr> 
    <td class="addTd">流程名称*</td>
    <td><label>
    <c:if test="${not empty object.flowName}"><s:textfield name="flowName" value="%{object.flowName}"  style="width:240px;" /></c:if>
      <c:if test="${empty object.flowName}"> <s:textfield id="flowName"  name="flowName"  style="width:240px;" /></c:if>
       <span id="flowNameTip" style="line-height: "></span>
    </label></td>
  </tr>
      <tr> 
    <td class="addTd">业务模块*</td>
    <td><label><select  id="optId"   name="optId" style="width:140px;">   
			<option value="0">   
					<c:out value="-- 请选择 --"/>   
			</option>    
   ...
   <tr> 
    ...
    <td><label>
    <c:if test="${not empty object.timeLimit}"><s:textfield id="timeLimit1"  name="object.timeLimit" value="%{object.timeLimit}" onchange="changeTL();"  style="width:140px;" /></c:if>
      <c:if test="${empty object.timeLimit}"> <s:textfield id="timeLimit1"  name="object.timeLimit"  style="width:140px;"  onchange="changeTL();" /></c:if>
    ...
    <td>
	    <select  id="expireOpt1"   name="object.expireOpt"  style="width:140px;">   
				<option value="0">   
						<c:out value="-- 请选择 --"/>   
				</option>    
