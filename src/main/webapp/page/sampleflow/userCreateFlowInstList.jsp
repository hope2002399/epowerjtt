...
<%-- 						<td class="addTd">包含节点:</td>
 ...
 --%>						<td class="addTd">包含完成:</td>
					...
					<tr>
						<td colspan="8" >
							<s:submit method="listUserCreate"  value="查询" cssClass="btn"/>&nbsp;
		...
		<ec:table action="sampleFlowManager!listUserCreate.do" items="objList" var="wfFlowInstance"
