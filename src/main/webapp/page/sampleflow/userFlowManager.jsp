				...
				<table cellpadding="0" cellspacing="0" align="left">
					...
					<tr >
						...
						<sj:datepicker id="s_createtime"
							name="s_createtime" value="%{#parameters['s_createtime']}" style="width:180px"
...
<%-- 						<td class="addTd">包含节点:</td>
 ...
 --%>						<td class="addTd">流程状态:</td>
					...
					<tr>
						<td colspan="8" >
							<s:submit method="listMyUnitFlow"  value="查询" cssClass="btn"/>&nbsp;
		...
		<ec:table action="sampleFlowManager!listMyUnitFlow.do" items="objList" var="wfFlowInstance"
			...
			<ec:row>
				...
				<ec:column property="opt" title="操作" sortable="false"
					...
					--><a href='sampleFlowManager!listNodesByUnitFlow.do?flowInstId=${wfFlowInstance.flowInstId}'>流程管理</a>
