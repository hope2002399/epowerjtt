...
<%@ include file="/page/common/messages.jsp"%>
		<fieldset style="padding: 10px;">
			...
			<s:form action="punishrecordparam"  method="post" namespace="/punish" id="punishrecordparamForm" enctype="multipart/form-data">
					<s:submit method="punishrecordparamSave" id="save" cssClass="btn" value="保存" />
				<input type="button" class="btn" value="返回" onclick="javascript:history.go(-1);" />
				
				<input id="orgId" type="hidden" name="orgId" value="${object.orgId}" />
				<input id="bookdate" type="hidden" name="bookdate" value="${object.bookdate}" />
			...
			<table border="0" cellpadding="0" cellspacing="0" class="viewTable">		
				...
				<tr>
					...
					<td align="left">
							...
							<input type="text" name="personnum" value="${object.personnum}">（元）
					</td>
				</tr>
				<tr>
					<td class="addTd">
					...
					<td align="left">
						...
						<input type="text" name="corpnum" value="${object.corpnum}">（元）
					</td>
				</tr>
