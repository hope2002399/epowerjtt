...
<body onload="changPaperType();doChange();">
	...
	<s:form action="pcpunishStandard" method="post" namespace="/punish"
		styleId="pcpunishStandardForm"
		onsubmit="return validatepcpunishStandardForm(this);">
		<s:submit method="save" cssClass="btn" key="opt.btn.save"></s:submit>
		<input type="button" Class="btn" onclick="window.history.back()"
			value="返回" />
		<input id="punishclassid" type="hidden" name="punishclassid"
			value="${object.punishclassid}" />
		<fieldset style="padding: 10px; display: block; margin-bottom: 10px;">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="viewTable">
				...
				<tr>
					...
					<td align="left" colspan="3">${punishclassname}</td>
				<tr>
