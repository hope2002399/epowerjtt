...
<div class="pageContent">
	...
	<table class="list" width="100%" layoutH=".pageHeader 55">
...
<%--					<td>
					...
					<td>
						...
						<a href="${pageContext.request.contextPath}/stat/queryModel!toCopy.do?modelName=${queryModel.modelName}" 
							title='复制为新模板' target="dialog" rel="COPY_MODEL" resizable="false"
							external="true" mask="true" maxable="false" drawable="true">
							<span title="复制为新模板" class="icon icon-copy"></span>
						</a>
