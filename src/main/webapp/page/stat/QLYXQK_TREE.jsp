...
<div class="pageContent">
	...
	<table id="dataTab" class="list stat" layoutH=".pageHeader 1" style="width:100%; table-layout: fixed;">
...
<script type="text/javascript">
	...
	$(function() {
		if ($('#dataTab td').length == 0) {
			$('#dataTab tbody tr').remove();
		};
		
		var code = $('#dataTab tbody tr:first').attr('data-tt-id');
		var text = $('#dataTab tbody td:first').text().trim();
		
	    // 展开顶级
		$('#dataTab').dataTab({ expandable: true }).dataTab("expandNode", code);
	    
	    $.myChart.init('#dataTab', text ,{
	    	//button: false,
	    	stat: [{
	    		chartType: 'column',
	    		type: 'line',
