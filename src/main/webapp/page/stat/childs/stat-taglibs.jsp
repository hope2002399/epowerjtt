...
<link href="${pageContext.request.contextPath}/scripts/jquery/jquery.treetable/stylesheets/jquery.treetable.css" rel="stylesheet" type="text/css" media="screen" />
<link href="${pageContext.request.contextPath}/scripts/jquery/jquery.treetable/stylesheets/jquery.treetable.theme.default.css" rel="stylesheet" type="text/css" media="screen" />

<style>
	table.stat {table-layout: fixed;}
	table.stat a,table.stat a:VISITED,table.stat a:HOVER {text-decoration: none; color:}
	body {
