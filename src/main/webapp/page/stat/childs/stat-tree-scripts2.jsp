...
<script src="${pageContext.request.contextPath}/scripts/jquery/jquery.jqprint-0.3.js" type="text/javascript"></script>
...
<script src="${pageContext.request.contextPath}/scripts/jquery/zTree_v3/js/jquery.ztree.core-3.5.min.js"></script>
