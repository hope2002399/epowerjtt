...
%>
	<tr>
		...
		<td align=center width=148 nowrap>
			<a href="javascript:location.href='TemplateEdit.jsp?RecordID=<%=mRecordID%>&FileType=<%=mFileType%>&tempType=<%=tempType%>'" >修改</a>
			<a href="javascript:ConfirmDel('TemplateDel.jsp?RecordID=<%=mRecordID%>&tempType=<%=tempType%>');" >删除</a>
			<a href="javascript:location.href='TemplateCopy.jsp?RecordID=<%=mRecordID%>&FileType=<%=mFileType%>&tempType=<%=tempType%>&operType=1'" >复制模版</a>
		</td>
	</tr>
<%
      }
