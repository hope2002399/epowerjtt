...
function initLayout(){
	var iContentW;
	if($("#layout").width()!= $(window).width()) iContentW = $("#layout").width() - (CentitUI.ui.sbar ? $("#sidebar").width() + 10 : 34) - 5;
	else iContentW = $(window).width() - (CentitUI.ui.sbar ? $("#sidebar").width() + 10 : 34) - 5;
