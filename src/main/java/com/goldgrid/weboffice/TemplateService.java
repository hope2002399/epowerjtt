...
public class TemplateService {
     ...
     * @return
     */
    public static String getTemplate(String objId, String templateType,
            String fileType) {
        iDBManager2000 DbaObj = new iDBManager2000();
        String mTemplateList, mstr = "";
        mTemplateList = "<select id=" + objId + " name=" + objId
                + " onChange='openTemplate(this.value);'>";
        mTemplateList = mTemplateList + "<option value=''>----请选择----</option>";
