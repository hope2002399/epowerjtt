...
public class OfficeServer extends HttpServlet {
    ...
    protected void service(HttpServletRequest request,
        ...
        OptStuffInfoDao optStuffInfoDao = (OptStuffInfoDao) wac
                .getBean("optStuffInfoDao");
        VUserTasksDao vUserTasksDao = (VUserTasksDao) wac
                .getBean("vUserTasksDao");
        OptBaseInfoDao optBaseInfoDao = (OptBaseInfoDao) wac
                .getBean("optBaseInfoDao");

        es = new ExecuteService();
        es.setOptStuffInfoDao(optStuffInfoDao);
        es.setUserTasksDao(vUserTasksDao);
        es.setOptBaseInfoDao(optBaseInfoDao);
