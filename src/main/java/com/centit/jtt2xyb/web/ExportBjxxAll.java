...
public class ExportBjxxAll extends BaseAction implements ServletResponseAware{
	...
	private void export(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		insertExcel(sheet,this.wssbtjService.getDataListDzzzAll(filterMap),dataStyle);
		//将以上缓存中的内容写到EXCEL文件中
