...
public class ExportZzxx extends BaseAction implements ServletResponseAware{
	...
	private void export(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		insertExcel(sheet,this.wssbtjService.getDataListZzxx(filterMap),dataStyle);
		//将以上缓存中的内容写到EXCEL文件中
