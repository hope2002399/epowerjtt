...
public class ExportYwHand extends BaseAction implements ServletResponseAware{
	...
	private void export(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		insertExcel(sheet,this.wssbtjService.getYwInfHadCountStat(startTime, endTime),dataStyle);
		//将以上缓存中的内容写到EXCEL文件中
	...
	private void getTitle(HSSFSheet sheet, HSSFWorkbook excel, HSSFCellStyle style) {
        ...
        String [] title1 = {"业务编码","业务名称 ","省级办件数量","市级办件数量","区县办件数量"};
