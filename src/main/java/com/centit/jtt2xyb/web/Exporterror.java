...
public class Exporterror extends BaseAction implements ServletResponseAware{
	...
	private void export(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		insertExcel(sheet,this.wssbtjService.getErrorList(startTime, endTime),dataStyle);
		//将以上缓存中的内容写到EXCEL文件中
	...
	private void getFirstRow(HSSFSheet sheet, String startTime, String endTime, HSSFCellStyle timeStyle) {
		...
		cell.setCellValue("申请人为个人，并且证号类型和证件号码不匹配的数据");
