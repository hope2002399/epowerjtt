...
public class Vpoweritemservicewithoutlob implements java.io.Serializable {
    private static final long serialVersionUID = 1L;
    private VpoweritemservicewithoutlobId cid;
    ...
    // Constructors
    /** default constructor */
    public Vpoweritemservicewithoutlob() {
    }

    /** minimal constructor */
    public Vpoweritemservicewithoutlob(VpoweritemservicewithoutlobId id
    ...
    public VpoweritemservicewithoutlobId getCid() {
        return this.cid;
    }

    public void setCid(VpoweritemservicewithoutlobId id) {
        this.cid = id;
    }

    public String getItemId() {
        if (this.cid == null)
            this.cid = new VpoweritemservicewithoutlobId();
    ...
    public void copy(Vpoweritemservicewithoutlob other) {
    ...
    public void copyNotNullProperty(Vpoweritemservicewithoutlob other) {
