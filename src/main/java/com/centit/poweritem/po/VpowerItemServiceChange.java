...
public class VpowerItemServiceChange implements java.io.Serializable {
    ...
    // Constructors
    /** default constructor */
    public VpowerItemServiceChange() {
    }

    /** minimal constructor */
    public VpowerItemServiceChange(String changeId) {
    ...
    /** full constructor */
    public VpowerItemServiceChange(String itemId, Long version, Date beginTime,
            ...
            String replyPeople, String auditor, String requester,
            String chgType, String chgContent, String chgResult,
            String chgReason, String replyContent, String auditContent,
            Date requestTime, Date auditTime, Date replyTime, String changeId,
            Date begTime) {
    ...
    public void copy(VpowerItemServiceChange other) {
    ...
    public void copyNotNullProperty(VpowerItemServiceChange other) {
