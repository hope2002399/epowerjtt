...
public class BpowerItemService implements java.io.Serializable {
    private static final long serialVersionUID = 1L;

    // private String itemId;
    // private String version ;
    private BpowerItemServiceId cid;
    private Date beginTime;
    private Date endTime;

    private String bpowerItemId;
    private String bpowerItemName;
    ...
    private String applyFormDemoName;

    public String getApplyFormDemoName() {
        return applyFormDemoName;
    }

    public void setApplyFormDemoName(String applyFormDemoName) {
        this.applyFormDemoName = applyFormDemoName;
    }
    ...
    public String getBpowerItemId() {
        return bpowerItemId;
    }

    public void setBpowerItemId(String bpowerItemId) {
        this.bpowerItemId = bpowerItemId;
    }

    public String getBpowerItemName() {
        return bpowerItemName;
    }

    public void setBpowerItemName(String bpowerItemName) {
        this.bpowerItemName = bpowerItemName;
    }

    public BpowerItemService(BpowerItemServiceId cid, Date beginTime,
            Date endTime, String orgId, String itemName, String itemStaName,
            String itemType, Long timeLimit, String isNetwork,
            String isFormula, byte[] processDesc, String phone, String address,
    ...
    public void setSrvDirectoryStuff(byte[] srvDirectoryStuff) {
        this.srvDirectoryStuff = srvDirectoryStuff;
    }
    ...
    // Constructors
    /** default constructor */
    public BpowerItemService() {
    }

    /** minimal constructor */
    public BpowerItemService(BpowerItemServiceId id, Date beginTime,
            Date endTime, String orgId, String itemName, String itemStaName,
            String itemType, Long timeLimit, String isNetwork,
            String isFormula, byte[] processDesc, String phone, String address,
            String zfAccording, String xwAccording, Date lastmodifytime,
    ...
    public BpowerItemService(BpowerItemServiceId id, String orgId,
    ...
    public BpowerItemService(BpowerItemServiceId id, Date beginTime,
            ...
            Long punishobject, String punishbasiscontent, String punishbasis,
            String islawsuit, String isreconsider, String dis_standard,
            String dis_detail) {
    ...
    public void setCid(BpowerItemServiceId cid) {
        this.cid = cid;
    }

    public BpowerItemServiceId getCid() {
        return cid;
    }

    public String getItemId() {
        if (this.cid == null)
            this.cid = new BpowerItemServiceId();
    ...
    public void copy(BpowerItemService other) {
        ...
        this.bpowerItemId = other.getBpowerItemId();
        this.bpowerItemName = other.getBpowerItemName();
        ...
        this.applyFormDemoName = other.getApplyFormDemoName();
    ...
    public void copyNotNullProperty(BpowerItemService other) {
        ...
        if (other.getBpowerItemId() != null)
            this.bpowerItemId = other.getBpowerItemId();
        if (other.getBpowerItemName() != null)
            this.bpowerItemName = other.getBpowerItemName();
        ...
        if (other.getProcessWorkDesc() != null)
            this.processWorkDesc = other.getProcessWorkDesc();
        if (other.getApplyFormDemoName() != null)
            this.applyFormDemoName = other.getApplyFormDemoName();
    ...
    public void clearProperties() {
        ...
        this.bpowerItemId = null;
        this.bpowerItemName = null;
    }
    ...
    public String display() {
        return "权力信息 [权力编码="
                ...
                + this.itemName
                + ", 权力类型="
                + CodeRepositoryUtil.getValue("ITEM_TYPE",
                        String.valueOf(this.itemType)) + "]";
    }
}
