...
public class VpoweritemservicewithoutlobId implements java.io.Serializable {
    ...
    // Constructors
    /** default constructor */
    public VpoweritemservicewithoutlobId() {
    }

    /** full constructor */
    public VpoweritemservicewithoutlobId(String itemId, Long version) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof VpoweritemservicewithoutlobId))
            return false;

        VpoweritemservicewithoutlobId castOther = (VpoweritemservicewithoutlobId) other;
        boolean ret = true;
