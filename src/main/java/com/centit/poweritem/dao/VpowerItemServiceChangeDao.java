...
public class VpowerItemServiceChangeDao extends
        BaseDaoImpl<VpowerItemServiceChange> {
    private static final long serialVersionUID = 1L;
    public static final Log log = LogFactory
            .getLog(VpowerItemServiceChangeDao.class);
    ...
    public VpowerItemServiceChange getSuppowerqlbgsqInfo(String itemId,
            Long version) {
        List<VpowerItemServiceChange> procs = this
                .listObjects("From VpowerItemServiceChange where item_id =  "
