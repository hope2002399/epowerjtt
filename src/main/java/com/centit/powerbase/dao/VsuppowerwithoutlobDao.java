...
public class VsuppowerwithoutlobDao extends BaseDaoImpl<Vsuppowerwithoutlob> {
    ...
    public Map<String, String> getFilterField() {
        if (filterField == null) {
            ...
            filterField.put(CodeBook.ORDER_BY_HQL_ID, " item_type,item_id , version ");
        }
        return filterField;
    }
    ...
    public List<Vsuppowerwithoutlob> listSuppowerWithoutLob(String flag,
        ...
        List<Vsuppowerwithoutlob> list = new ArrayList<Vsuppowerwithoutlob>();
        ...
        if (StringUtils.isNotBlank(itemid)) {
            if ("sq".equals(flag)) {
                sql.append(" and B_V_PowerWithoutlob.item_id like '%" + itemid
                        + "%' ");
            } else {
