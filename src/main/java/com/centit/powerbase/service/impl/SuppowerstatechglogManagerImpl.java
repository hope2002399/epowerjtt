...
public class SuppowerstatechglogManagerImpl extends
        BaseEntityManagerImpl<Suppowerstatechglog> implements
        SuppowerstatechglogManager {
    private static final long serialVersionUID = 1L;
    public static final Log log = LogFactory
            .getLog(SuppowerstatechglogManager.class);
    ...
    public Suppowerstatechglog getObjectByIdAndVersion(String itemId,
        ...
        return suppowerstatechglogDao.getObjectByIdAndVersion(itemId, version);
    }
