...
public class PcpunishStandard implements java.io.Serializable {
    ...
    , Long isinuse, Long punishtype, String toplimit, String toplimitUnit,
            String lowlimit, String lowlimitUnit, String baseName,
            String baseToplimit, String baseLowlimit, String baseUnit,
            String remark) {
        this.cid = id;
