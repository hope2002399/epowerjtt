...
public class PcfreeumpiretypeId implements java.io.Serializable {
    ...
    public boolean equals(Object other) {
        ...
        ret = ret
                && (this.getDegreeno() == castOther.getDegreeno() || (this
                        .getDegreeno() != null
                        && castOther.getDegreeno() != null && this
                        .getDegreeno().equals(castOther.getDegreeno())));
    ...
    public int hashCode() {
        ...
        result = 37
                * result
                + (this.getDegreeno() == null ? 0 : this.getDegreeno()
                        .hashCode());
