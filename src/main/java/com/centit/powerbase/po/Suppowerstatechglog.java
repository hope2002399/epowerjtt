...
public class Suppowerstatechglog implements java.io.Serializable {
    ...
    /** minimal constructor */
    public Suppowerstatechglog(String chgno) {
    ...
    /** full constructor */
    public Suppowerstatechglog(String chgno, String itemId, Long version,
            Date beginTime, Date endTime, String chgType, String recoder,
            String remark) {
