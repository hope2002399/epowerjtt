...
public class RecordFileBasic implements java.io.Serializable {
    ...
    public RecordFileBasic() {

    }

    public RecordFileBasic(String so) {

    }

    public void copy(RecordFileBasic other) {
