...
public class Suppowerchglog implements java.io.Serializable {
    ...
    /** minimal constructor */
    public Suppowerchglog(String changeId) {
    ...
    /** full constructor */
    public Suppowerchglog(String changeId, String itemId, Long version,
            String chgReason, String chgContent, Date requestTime,
            Date beginTime, String requester, String chgResult, Date auditTime,
            String auditor, String auditContent, String chgType,
            String replyPeople, Date replyTime, String replyContent) {
