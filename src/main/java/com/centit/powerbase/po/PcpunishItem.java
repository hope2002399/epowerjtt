...
public class PcpunishItem implements java.io.Serializable {
    ...
    private Set<PcpunishStandard> pcpunishStandards = null;// new
                                                           // ArrayList<PcpunishStandard>();
    ...
    /** minimal constructor */
    public PcpunishItem(String punishclassid, String punishclassname,
            Long depid, Long isinuse) {
    ...
    /** full constructor */
    public PcpunishItem(String punishclassid, String itemId, String version,
            String punishclassname, Long depid, String punishclasscode,
            Long punishobject, Long isinuse, String punishbasiscontent,
            String punishbasis, String remark, String islawsuit,
            String isreconsider) {
     ...
     * 
     */
    public void replacePcpunishStandards(
            List<PcpunishStandard> pcpunishStandards) {
        ...
        for (PcpunishStandard newdt : newObjs) {
            found = false;
            for (Iterator<PcpunishStandard> it = getPcpunishStandards()
                    .iterator(); it.hasNext();) {
                PcpunishStandard odt = it.next();
                if (odt.getCid().equals(newdt.getCid())) {
                    odt.copy(newdt);
