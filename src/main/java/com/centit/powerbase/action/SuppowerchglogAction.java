...
public class SuppowerchglogAction extends
    ...
    public String SuppowerReplySave() {
        ...
        if ("1".equals(object.getChgResult())) {// 申请同意修改
            try {
                ...
                Suppower suppower_temp = new Suppower();
    ...
    public String listVersion() {
        ...
        List<SuppowerStandard> list2 = SupPowerAction
                .genxmlStandardList(suppower.getRisk());
        request.setAttribute("list2", list2);
        List<SuppowerStandard> list1 = SupPowerAction
                .genProcessWorkDescList(suppower.getProcessWorkDesc());
        request.setAttribute("list1", list1);
        List<SuppowerStandard> list3 = SupPowerAction
                .genAcceptConditionList(suppower.getAcceptCondition());
        request.setAttribute("list3", list3);
        request.setAttribute("sup", suppower);
        request.setAttribute("suppowerList", suppowerList);
