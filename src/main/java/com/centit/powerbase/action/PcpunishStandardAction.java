 ...
 * @version
 */
public class PcpunishStandardAction extends
        BaseEntityExtremeAction<PcpunishStandard> {
    ...
    public void setPcpunishStandardsList(
            List<PcpunishStandard> pcpunishStandardsList) {
    ...
    public String save() {
        ...
        PcpunishStandard pcpunishStandard = pcpunishStandardMag
                .getObjectByItemsId(object.getItemId(),
                        Long.parseLong(object.getVersion()),
    ...
    public String listPcType() {
        pcpunishStandardsList = pcpunishStandardMag.listPcType(
                object.getItemId(), Long.parseLong(object.getVersion()));
    ...
    @Override
    public String edit() {
        Suppower pcpunishItem = suppowerManager.getObjectById(
                object.getItemId(), Long.parseLong(object.getVersion()));
        if (StringUtils.isNotBlank(object.getPunishtypeid())) {
            object = pcpunishStandardMag.getObjectByItemsId(object.getItemId(),
                    Long.parseLong(object.getVersion()),
                    object.getPunishtypeid());
    ...
    public String editIsInUse() {
        object = pcpunishStandardMag.getObjectByItemsId(object.getItemId(),
                Long.parseLong(object.getVersion()), object.getPunishtypeid());
    ...
    public String editFreeumpireTypeIsInUse() {
        ...
        pcfreeumpiretypeList = pcfreeumpiretypeManager
                .getPCFreeUmpireTypeListByClassID(object.getItemId(),
                        Long.parseLong(object.getVersion()),
                        object.getPunishtypeid());
