...
public class DataBasicInfoImpl implements IDataBasicInfo {
    ...
    @Override
    public List<Dataenterprise> getDataenterpriseList(
    ...
    @Override
    public List<Dataenterprise> getDataenterpriseList(String shql,
            Map<String, Object> filterMap, PageDesc pageDesc) {
        return this.dataenterpriseDao.listObjects(shql, filterMap, pageDesc);
    }

    @Override
    public List<Dataindividual> getDataindividualList(
            Map<String, Object> filterMap, PageDesc pageDesc) {
    ...
    @Override
    public List<Dataindividual> getDataindividualList(String shql,
            Map<String, Object> filterMap, PageDesc pageDesc) {
    ...
    public Dataenterprise getDataenterprise(Long enterpriseid) {
        ...
        List<Dataenterprise> listObjects = this.dataenterpriseDao
    ...
    public Dataindividual getDataindividual(Long individualid) {
        ...
        List<Dataindividual> listObjects = this.dataindividualDao
                .listObjects(filterMap);
