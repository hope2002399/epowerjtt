...
/**
 * 针对组织结构、个人等基础信息操作的接口 TODO Class description should be added
 * 
 * @author tyj
 * @create 2013-9-24
 * @version
...
public interface IDataBasicInfo {
     ...
     * 
     * @param filterMap
     *            支持根据enterpriseid, application,lastmoddate等过滤
     * @param pageDesc
     *            分页实体类参数
     * @return
     */
     ...
     * @return
     */
    List<Dataenterprise> getDataenterpriseList(String shql,
     ...
     * 
     * @param filterMap
     *            支持根据individualid, application,lastmoddate等过滤
     * @param pageDesc
     *            分页实体类参数
     * @return
     */
     ...
     * @return
     */
    List<Dataindividual> getDataindividualList(String shql,
            Map<String, Object> filterMap, PageDesc pageDesc);
