...
public class WfOrganizeId implements java.io.Serializable {
    ...
    /** full constructor */
    public WfOrganizeId(Long flowInstId, String unitCode, String roleCode) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof WfOrganizeId))
            return false;

        WfOrganizeId castOther = (WfOrganizeId) other;
        boolean ret = true;
