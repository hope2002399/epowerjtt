...
public class PunishResultLog implements java.io.Serializable {
    private static final long serialVersionUID = 1L;
    private PunishResultLogId cid;
    ...
    // Constructors
    /** default constructor */
    public PunishResultLog() {
    }

    /** minimal constructor */
    public PunishResultLog(PunishResultLogId id

    , String orgId, String internalNo, String itemId, String program,
            String accordance, String standard, String punishDeside,
            String punishClass, String punishResult, String attachment,
            Date finishDate, Date createDate, Date updateDate) {
        this.cid = id;
    ...
    public PunishResultLogId getCid() {
        return this.cid;
    }

    public void setCid(PunishResultLogId id) {
        this.cid = id;
    }

    public String getNo() {
        if (this.cid == null)
            this.cid = new PunishResultLogId();
    ...
    public void copy(PunishResultLog other) {
    ...
    public void copyNotNullProperty(PunishResultLog other) {
