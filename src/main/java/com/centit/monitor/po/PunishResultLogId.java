...
public class PunishResultLogId implements java.io.Serializable {
    ...
    // Constructors
    /** default constructor */
    public PunishResultLogId() {
    }

    /** full constructor */
    public PunishResultLogId(String no, Long changNo) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof PunishResultLogId))
            return false;

        PunishResultLogId castOther = (PunishResultLogId) other;
        boolean ret = true;
