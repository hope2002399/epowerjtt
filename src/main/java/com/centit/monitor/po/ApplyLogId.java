...
public class ApplyLogId implements java.io.Serializable {
    ...
    /** full constructor */
    public ApplyLogId(String no, Long changNo) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof ApplyLogId))
            return false;

        ApplyLogId castOther = (ApplyLogId) other;
        boolean ret = true;
