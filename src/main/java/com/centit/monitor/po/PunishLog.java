...
public class PunishLog implements java.io.Serializable {
    private static final long serialVersionUID = 1L;
    private PunishLogId cid;
    ...
    /** minimal constructor */
    public PunishLog(PunishLogId id

    , String orgId, String internalNo, String itemId, String department,
            String ajAddr, Date ajOccurDate, String targetType,
            String punishTarget, Long promise, String promiseType,
    ...
    , String orgId, String internalNo, String itemId, String department,
            String ajAddr, Date ajOccurDate, String source, String fact,
            String targetType, String punishTarget, String targetCode,
            String targetPaperType, String targetPaperNumber,
            String targetPhone, String targetMobile, String targetAddress,
            String targetZipCode, String targetEmail, String reporter,
            Date reporterDate, String reporterPaperType,
    ...
    public PunishLogId getCid() {
        return this.cid;
    }

    public void setCid(PunishLogId id) {
        this.cid = id;
    }

    public String getNo() {
        if (this.cid == null)
            this.cid = new PunishLogId();
    ...
    public void copy(PunishLog other) {
    ...
    public void copyNotNullProperty(PunishLog other) {
