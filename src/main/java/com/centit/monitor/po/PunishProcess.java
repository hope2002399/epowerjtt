...
public class PunishProcess implements java.io.Serializable {
    ...
    // Constructors
    /** default constructor */
    public PunishProcess() {
    }

    /** minimal constructor */
    public PunishProcess(String no, Long noOrd, String orgId,
            String internalNo, String itemId, String tacheId, String tacheName,
            String department, String userName, String status, String note,
    ...
    public PunishProcess(String no, Long noOrd, String orgId,
            ...
            String userName, String status, Long promise, String promiseType,
            String promiseStartSign, Long isrisk, String risktype,
            String riskdescription, String riskresult, String note,
            String attachment, String evidence, Date processDate,
            String nodeId, Long nodeAttribute, Date createDate,
    ...
    public void copy(PunishProcess other) {
    ...
    public void copyNotNullProperty(PunishProcess other) {
