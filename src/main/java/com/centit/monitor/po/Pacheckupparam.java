...
public class Pacheckupparam implements java.io.Serializable {
    ...
    // Constructors
    /** default constructor */
    public Pacheckupparam() {
    }

    /** minimal constructor */
    public Pacheckupparam(String paramNo, String paramName,
            String defaultValue, String paramDesc) {
    ...
    /** full constructor */
    public Pacheckupparam(String paramNo, String paramName,
            String defaultValue, String paramValue, String paramDesc,
            String paramType) {
    ...
    public void copy(Pacheckupparam other) {
    ...
    public void copyNotNullProperty(Pacheckupparam other) {
