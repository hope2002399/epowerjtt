...
public class PunishDoc implements java.io.Serializable {
    ...
    /** minimal constructor */
    public PunishDoc(String no, Date updateDate, String orgId,
    ...
    /** full constructor */
    public PunishDoc(String no, Date updateDate, Date readDate,
            String syncSign, String errorDesc, String orgId, String internalNo,
    ...
    public PunishDoc(InFlowInfo inflowinfo, boolean b) {
        if (null != inflowinfo) {
    ...
    public void copy(PunishDoc other) {
    ...
    public void copyNotNullProperty(PunishDoc other) {
