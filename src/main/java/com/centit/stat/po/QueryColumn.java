...
public class QueryColumn implements java.io.Serializable {
    ...
    public QueryColumn(Integer colOrder, String colName, String colType,
            String colFormat, String optType, String drawChart,
            String colLogic, String isShow) {
    ...
    , String optType, String drawChart, String colType, String colLogic,
            Integer colorder, String isShow, String showType) {
        this.cid = id;
