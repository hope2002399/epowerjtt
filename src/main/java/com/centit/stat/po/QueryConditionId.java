...
public class QueryConditionId implements java.io.Serializable {
    ...
    public boolean equals(Object other) {
        ...
        ret = ret
                && (this.getCondName() == castOther.getCondName() || (this
                        .getCondName() != null
                        && castOther.getCondName() != null && this
                        .getCondName().equals(castOther.getCondName())));
    ...
    public int hashCode() {
        ...
        result = 37
                * result
                + (this.getModelName() == null ? 0 : this.getModelName()
                        .hashCode());

        result = 37
                * result
                + (this.getCondName() == null ? 0 : this.getCondName()
                        .hashCode());
