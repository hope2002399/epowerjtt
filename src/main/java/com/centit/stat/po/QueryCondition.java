...
public class QueryCondition implements java.io.Serializable {
     ...
     * @param condValue
     */
    public QueryCondition(String modelName, String condName, String condLabel,
            String condType, String condValue) {
     ...
     * @param condValue
     */
    public QueryCondition(String modelName, String condName, String condStyle,
            String condValue) {
    ...
    , String condLabel, String condType, String condStyle, String compareType,
            String condValue, Integer condOrder, String condPlace,
            String condFilterSql) {
        this.cid = id;
