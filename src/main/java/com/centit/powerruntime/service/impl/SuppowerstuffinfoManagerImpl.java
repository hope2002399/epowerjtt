...
public class SuppowerstuffinfoManagerImpl extends
        BaseEntityManagerImpl<Suppowerstuffinfo> implements
    ...
    public void setSuppowerstuffinfoDao(
            SuppowerstuffinfoDao suppowerstuffinfoDao) {
