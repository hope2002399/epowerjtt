...
public class SuppowerstuffgroupManagerImpl extends
        BaseEntityManagerImpl<Suppowerstuffgroup> implements
        SuppowerstuffgroupManager {
    ...
    public void setSuppowerstuffgroupDao(
            SuppowerstuffgroupDao suppowerstuffgroupDao) {
