...
public class VOptApplyTaskList implements java.io.Serializable {
    ...
    public VOptApplyTaskList(Long nodeInstId,

    String unitCode, String flowPhase,

    String userCode,

    Long flowInstId, String authDesc, String flowOptName, String flowOptTag,
            String nodeName, String nodeType, String nodeOptType,
            String optName, String methodName, String optId, String optParam,
            String optUrl, String optMethod, String optDesc, String optCode,
            Date createTime, String expireOpt, Date lastUpdateTime,
            String lastUpdateUser, Long promiseTime, Long timeLimit,
            String grantor, String roleType, String roleCode, String inststate,
            Date nodeCreateTime, Date nodeExpireTime, Long expireOptSign,
            Date nodeLastUpdateTime, Date flowExpireTime, Long flowTimeLimit,
            String djId, String transaffairname, String bizstate,
            String biztype, String orgcode, String orgname,
            ...
            String sendArchiveNo, String acceptArchiveNo, Long taskId,
            String applyItemType) {
        this.taskId = taskId;
