...
public class OptApplyInfoNet implements java.io.Serializable {
    ...
    private OptBaseInfoNet optBaseInfoNet;
    ...
    public OptApplyInfoNet(String netId, String djId, String channelName,
            String channelLevel, String elevationSystem, Date applyDate,
        ...
        this.optBaseInfoNet = optBaseInfoNet;
    }
    ...
    // Constructors
    /** default constructor */
    public OptApplyInfoNet() {
    }

    /** minimal constructor */
    public OptApplyInfoNet(String netId) {
    ...
    public void copy(OptApplyInfoNet other) {
        ...
        this.optBaseInfoNet = other.getOptBaseInfoNet();
        this.legal_person = other.getLegal_person();
    }

    public void copyNotNullProperty(OptApplyInfoNet other) {
    ...
    public void clearProperties() {
        ...
        this.optBaseInfoNet = new OptBaseInfoNet();
    }

    public OptBaseInfoNet getOptBaseInfoNet() {
        return optBaseInfoNet;
    }
    ...
    public void setOptBaseInfoNet(OptBaseInfoNet optBaseInfoNet) {
        this.optBaseInfoNet = optBaseInfoNet;
    }
}
