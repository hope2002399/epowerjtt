...
public class YwFiles implements java.io.Serializable {
    ...
    /** minimal constructor */
    public YwFiles(String sortId, String stuffName) {
    ...
    /** full constructor */
    public YwFiles(String sortId, String groupId, String stuffType,
    ...
    public void copy(YwFiles other) {
    ...
    public void copyNotNullProperty(YwFiles other) {
