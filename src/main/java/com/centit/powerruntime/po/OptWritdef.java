...
public class OptWritdef implements java.io.Serializable {
    ...
    /** full constructor */
    public OptWritdef(Long writid, String temptype, String recordid,
            String writcode, String initvalue, String isinuse, String remark) {
