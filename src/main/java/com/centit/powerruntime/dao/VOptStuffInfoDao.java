...
public class VOptStuffInfoDao extends BaseDaoImpl<VOptStuffInfo> {
    ...
    public VOptStuffInfo getStuffInfoByFileType(String djId, String fileType) {
        String hql = "from VOptStuffInfo where djId = "
    ...
    @SuppressWarnings("unchecked")
    public List<VOptStuffInfo> getStuffInfoListByFileType(String djId,
            String fileType) {
        String hql = "from VOptStuffInfo where djId = "
                + HQLUtils.buildHqlStringForSQL(djId);
        if (StringUtils.isNotBlank(fileType)) {
     ...
     */
    @SuppressWarnings("unchecked")
    public List<VOptStuffInfo> getStuffInfoListByNodeinstid(String djId,
            String nodeinstid) {
        String hql = "from VOptStuffInfo where djId = "
                + HQLUtils.buildHqlStringForSQL(djId);
    ...
    public VOptStuffInfo getStuffInfoByArchiveType(String djId,
            String archiveType) {
        String hql = "from VOptStuffInfo where djId = '" + djId
     ...
     * @return
     */
    public VOptStuffInfo getStuffInfoByType(String djId, String fileType,
            String archiveType) {
        String hql = "from VOptStuffInfo where djId = "
    ...
    public List<VOptStuffInfo> getStuffsByDjId(String djId) {
        String hql = "from VOptStuffInfo where djId = "
                + HQLUtils.buildHqlStringForSQL(djId) + " order by uploadtime";
        List<VOptStuffInfo> sqclList = (List<VOptStuffInfo>) this
                .findObjectsByHql(hql);
        return sqclList;
    }
