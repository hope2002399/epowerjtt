...
public class QlQdsjstsxtjDao extends BaseDaoImpl<QlQdsjstsxtj>
	{
		private static final long serialVersionUID = 1L;
		public static final Log log = LogFactory.getLog(QlQdsjstsxtjDao.class);
		
	public Map<String, String> getFilterField() {
		if( filterField == null){
			filterField = new HashMap<String, String>();
			filterField.put("orgname" , CodeBook.EQUAL_HQL_ID);
			filterField.put("jtcode" , CodeBook.LIKE_HQL_ID);
