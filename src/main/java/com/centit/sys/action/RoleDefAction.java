...
public class RoleDefAction extends BaseEntityExtremeAction<FRoleinfo> implements
    ...
    public void setRoleSecurityMetadata(
            CentitSecurityMetadata roleSecurityMetadata) {
    ...
    public String list() {
        try {
            Map<String, Object> filterMap = convertSearchColumn((Map<Object, Object>) request
                    .getParameterMap());
            filterMap.put("PROLECODE", "G-%");
            /* filterMap.put("PROLECODE", "P-%"); */
    ...
    public String edit() {
        ...
        try {
            ...
            List<FRolepower> pls = sysRoleManager.getRolePowers(object
                    .getRolecode());
    ...
    public String newEdit() {
        ...
        // fOptinfos = sortOptInfoAsTree (
        // CodeRepositoryUtil.getOptinfoList("R"),optIndex);
    ...
    public String save() {
        ...
        try {
            ...
            if (!"T".equals(isPublic)) {
                if (!object.getRolecode().startsWith("G-")
                        && !object.getRolecode().startsWith("P-")) {
            ...
            try {
                ...
                sysRoleManager
                        .saveRolePowers(object.getRolecode(), optcodelist);
