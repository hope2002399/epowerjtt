...
public class UnitAction extends BaseEntityExtremeAction<FUnitinfo> {
    ...
    public String view() {
        try {
            ...
            unitusers = sysUnitManager
                    .getSysUsersByUnitId(object.getUnitcode());
    ...
    public String editUnitPower() {
        ...
        try {
            ...
            FUnitinfo dbobject = sysUnitManager.getObjectById(object
                    .getUnitcode());
            object = dbobject;
            List<FRolepower> list = sysRoleManager.getRolePowers("G$"
                    + object.getUnitcode());
    ...
    public String saveUnitPower() {
        try {
            ...
            sysRoleManager.saveRolePowers("G$" + object.getUnitcode(),
                    optcodelist);
            savedMessage();
            SYS_OPT_LOG.log(
    ...
    public String saveUnitUser() {
        ...
        try {
            ...
            FUserunit dbobject = sysUnitManager.findUnitUserById(userunit
                    .getId());
            ...
            if (dbobject != null) {
                ...
                List<FUserunit> ls = sysUnitManager
                        .getSysUnitsByUserId(userunit.getUsercode());
            ...
            try {
                ...
                SYS_OPT_LOG.log(
                        ((FUserinfo) this.getLoginUser()).getUsercode(),
                        userunit.getId().toString(), userunit.display(),
                        oldValue);
    ...
    public String editAddressBook() {
        ...
        try {
            ...
            if (object.getAddrbookid() == null
                    || object.getAddrbookid().equals(0L)) {
