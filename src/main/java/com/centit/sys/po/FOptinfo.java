...
public class FOptinfo implements java.io.Serializable {
    ...
    /** minimal constructor */
    public FOptinfo(String optid, String optname) {
    ...
    /** full constructor */
    public FOptinfo(String optid, String preoptid, String optname,
    ...
    public String display() {
        ...
        List<LabelValueBean> lbls = CodeRepositoryUtil
                .getLabelValueBeans("OPTTYPE");
