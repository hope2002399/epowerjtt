...
public class FUserunitId implements java.io.Serializable {
    ...
    /** full constructor */
    public FUserunitId(String unitcode, String usercode, String userstation,
            String userrank) {
    ...
    public boolean equals(Object other) {
        ...
        return ((this.getUnitcode() == castOther.getUnitcode()) || (this
                .getUnitcode() != null && castOther.getUnitcode() != null && this
    ...
    public int hashCode() {
        ...
        result = 37
                * result
                + (getUserstation() == null ? 0 : this.getUserstation()
                        .hashCode());
        result = 37 * result
