...
public class FDatacatalog implements java.io.Serializable {
    ...
    /** minimal constructor */
    public FDatacatalog(String catalogcode, String catalogname,
            String catalogstyle, String catalogtype, String isupload) {
    ...
    /** full constructor */
    public FDatacatalog(String catalogcode, String catalogname,
            String catalogstyle, String catalogtype, String catalogdesc,
            String isupload, String fielddesc) {
