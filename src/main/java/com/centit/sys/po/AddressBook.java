...
public class AddressBook implements java.io.Serializable {
    ...
    /** minimal constructor */
    public AddressBook(Long addrbookid, String bodytype, String bodycode) {
    ...
    /** full constructor */
    public AddressBook(Long addrbookid, String bodytype, String bodycode,
            String representation, String unitname, String deptname,
            String rankname, String email, String email2, String email3,
            String homepage, String qq, String msn, String wangwang,
            String buzphone, String buzphone2, String buzfax, String assiphone,
            String callbacphone, String carphone, String unitphone,
            String homephone, String homephone2, String homephone3,
            String homefax, String mobilephone, String mobilephone2,
            String mobilephone3, String unitzip, String unitprovince,
            String unitcity, String unitdistrict, String unitstreet,
            String unitaddress, String homezip, String homeprovince,
            String homecity, String homedistrict, String homestreet,
            String homeaddress, String home2zip, String home2province,
            String home2city, String home2district, String home2street,
            String home2address, String inuseaddress, String memo) {
    ...
    public void makeSearchString() {
        StringBuilder ss1 = new StringBuilder(), ss2 = new StringBuilder();
        ...
        if (this.unitprovince != null)
            ss2.append(' ').append(
                    StringBaseOpt.getFirstLetter(this.unitprovince));
        if (this.unitcity != null)
        ...
        if (this.homeprovince != null)
            ss2.append(' ').append(
                    StringBaseOpt.getFirstLetter(this.homeprovince));
        if (this.homecity != null)
        ...
        if (this.home2province != null)
            ss2.append(' ').append(
                    StringBaseOpt.getFirstLetter(this.home2province));
        if (this.home2city != null)
