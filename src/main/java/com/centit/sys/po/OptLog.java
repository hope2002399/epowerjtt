...
public class OptLog implements java.io.Serializable {
    ...
    public OptLog(String usercode, String optid, String tagid,
    ...
    /** full constructor */
    public OptLog(Long logid, String loglevel, String usercode, Date opttime,
            String optid, String optmethod, String optcontent, String oldvalue) {
