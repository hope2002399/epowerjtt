...
public class VOptDef implements java.io.Serializable {
    ...
    public VOptDef(String optcode, String optid, String optname,
            String preoptid, String optmethod, String methodname,
            String optdesc, String opturl, String formcode, String opttype,
            Long msgno, String msgprm, String isintoolbar, Long imgindex,
            String topoptid, Long orderind) {
        this.optcode = optcode;
        this.optid = optid;
