...
public class OptRunRecId implements java.io.Serializable {
    ...
    public boolean equals(Object other) {
        ...
        ret = ret
                && (this.getActionurl() == castOther.getActionurl() || (this
                        .getActionurl() != null
                        && castOther.getActionurl() != null && this
                        .getActionurl().equals(castOther.getActionurl())));
    ...
    public int hashCode() {
        ...
        result = 37
                * result
                + (this.getActionurl() == null ? 0 : this.getActionurl()
                        .hashCode());

        result = 37
                * result
                + (this.getFuncname() == null ? 0 : this.getFuncname()
                        .hashCode());
