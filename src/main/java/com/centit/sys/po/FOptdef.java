...
public class FOptdef implements java.io.Serializable {
    ...
    /** minimal constructor */
    public FOptdef(String optcode, String optid) {
    ...
    /** full constructor */
    public FOptdef(String optcode, String optname, String optid,
    ...
    public FOptdef(String optcode, String optname, String optid,
            String optmethod, String optdesc, String isinworkflow) {
        this.optcode = optcode;
        this.optname = optname;
        this.optid = optid;
        this.optmethod = optmethod;
