...
public interface OptFlowNoInfoManager extends BaseEntityManager<OptFlowNoInfo> {
    ...
    public final static Date DefaultCodeDate = com.centit.support.utils.DatetimeOpt
            .createUtilDate(2000, 1, 1);
     ...
     * 
     * @param ownerCode
     *            根据 拥有者，如果设置为 DefaultOwnerCode 则这个编码则依赖于编码
     * @param codeCode
     *            类别代码
     * @param codeBaseDate
     *            编码的基准时间
     ...
     * 配合view对应的方法使用。
     */
    public void recordNextLsh(String ownerCode, String codeCode,
