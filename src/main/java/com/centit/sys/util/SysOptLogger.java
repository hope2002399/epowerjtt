...
public class SysOptLogger implements ISysOptLog, Serializable {
    ...
    private static OptLogManager getOptLogMag() {
        OptLogManager optLogManager = StartupListener
                .getCurrentWebApplicationContext().getBean("optLogManager",
                        OptLogManager.class);
    ...
    @Override
    public void log(String usercode, String tagId, String optMethod,
    ...
    public void log(String usercode, String tagId, String optContent) {
        this.log(usercode, this.optId, tagId, Thread.currentThread()
                .getStackTrace()[2].getMethodName(), optContent, null);
    ...
    public void log(OptLog optLog) {
        ...
        if (!StringUtils.hasText(optLog.getOptmethod())) {
            optLog.setOptmethod(Thread.currentThread().getStackTrace()[2]
                    .getMethodName());
        }
