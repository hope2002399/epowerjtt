...
public class FUserDetail extends FUserinfo implements UserDetails {
    ...
    /*
     * public List<FUserunit> getUnitinfo() { return super.getUserUnits(); }
     * 
    ...
    public FUserDetail(FUserinfo user) {
        super(user.getUsercode(), user.getUserpin(), user.getIsvalid(), user
                .getLoginname(), user.getUsername(), user.getUserdesc(), user
                .getLogintimes(), user.getActivetime(), user.getLoginip(), user
                .getAddrbookid());
        arrayAuths = null;
    ...
    /** minimal constructor */
    public FUserDetail(String usercode, String userstate, String loginname,
            String username) {
    ...
    public FUserDetail(String usercode, String userpin, String userstate,
        ...
        super(usercode, userpin, userstate, loginname, username, userdesc,
                logintimes, activeime, loginip, addrbookid);
        arrayAuths = null;
        lastUpdateRoleTime = null;
    }
    ...
    public void setAuthoritiesByRoles(List<FRoleinfo> roles) {
        ...
        for (FRoleinfo role : roles) {
            arrayAuths.add(new GrantedAuthorityImpl(RdbmsEntryHoder.ROLE_PREFIX
                    + role.getRolecode()));
        }
    ...
    private void loadAuthoritys() {
        ...
        List<FRoleinfo> roles = sysusrodao
                .getSysRolesByUsid(this.getUsercode());
    ...
    public boolean isCredentialsExpired() {
        ...
        /*
         * return (arrayAuths == null || lastUpdateRoleTime == null || (new
         * Date(System.currentTimeMillis())).getTime()-
         * lastUpdateRoleTime.getTime() > 10 * 60 * 1000);
         */
    }
