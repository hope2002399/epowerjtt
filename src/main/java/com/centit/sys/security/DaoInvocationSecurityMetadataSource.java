...
public class DaoInvocationSecurityMetadataSource implements
        FilterInvocationSecurityMetadataSource, CentitSecurityMetadata {
    private static final Log log = LogFactory
            .getLog(DaoInvocationSecurityMetadataSource.class);
    ...
    public Map<OptDesc, RdbmsEntryHoder> getRdbmsEntryHolderList() {
        if (lastUpdateCadTime != null
                && listEntryHoder != null
                &&
                // 角色权限库一个小时更新一次
                ((new Date(System.currentTimeMillis())).getTime()
                        - lastUpdateCadTime.getTime() < 60 * 60 * 1000)) {
    ...
    public Collection<ConfigAttribute> getAttributes(Object object)
        ...
        // cad.addConfigAttribute(new SecurityConfig(RdbmsEntryHoder.ROLE_PREFIX
        // + FORBIDDEN"));
        // return cad;
        return null;
    }
