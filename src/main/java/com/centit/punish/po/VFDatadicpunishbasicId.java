 ...
 */
// 数据字典的主键
public class VFDatadicpunishbasicId implements java.io.Serializable {
    ...
    /** default constructor */
    public VFDatadicpunishbasicId() {
    }

    /** full constructor */
    public VFDatadicpunishbasicId(String catalogcode, String datacode) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof VFDatadicpunishbasicId))
            return false;
        VFDatadicpunishbasicId castOther = (VFDatadicpunishbasicId) other;

        return ((this.getCatalogcode() == castOther.getCatalogcode()) || (this
                .getCatalogcode() != null && castOther.getCatalogcode() != null && this
                .getCatalogcode().equals(castOther.getCatalogcode())))
