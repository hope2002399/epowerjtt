 ...
 */
// 数据字典表
public class VFDatadicpunishbasic implements java.io.Serializable {

    // Fields
    private static final long serialVersionUID = -4063651885248484498L;
    private VFDatadicpunishbasicId id; // 主键id
    ...
    /** default constructor */
    public VFDatadicpunishbasic() {
        this.id = new VFDatadicpunishbasicId();
    }

    /** minimal constructor */
    public VFDatadicpunishbasic(VFDatadicpunishbasicId id) {
        this.id = id;
    }

    /** full constructor */
    public VFDatadicpunishbasic(VFDatadicpunishbasicId id, String extracode,
    ...
    public VFDatadicpunishbasicId getId() {
        return this.id;
    }

    public void setId(VFDatadicpunishbasicId id) {
        this.id = id;
    }
    ...
    public void copy(VFDatadicpunishbasic other) {
    ...
    public void copyNotNullProperty(VFDatadicpunishbasic other) {
    ...
    public void copyNotNullPropertyFromFDataDic(FDatadictionary other) {
        if (other.getId() != null) {
            this.getId().setCatalogcode(other.getId().getCatalogcode());
            this.getId().setDatacode(other.getId().getDatacode());
        }
        if (other.getExtracode() != null)
            this.extracode = other.getExtracode();
        if (other.getExtracode2() != null)
