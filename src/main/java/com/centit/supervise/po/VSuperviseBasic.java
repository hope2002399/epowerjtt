...
public class VSuperviseBasic implements java.io.Serializable {
    ...
    // Constructors
    /** default constructor */
    public VSuperviseBasic() {
    }

    /** minimal constructor */
    public VSuperviseBasic(String superviseNo) {
    ...
    /** full constructor */
    public VSuperviseBasic(String superviseNo, Long flowInstId, String bjType,
            ...
            String syncErrorDesc, String monitorSource) {
    ...
    public void copy(VSuperviseBasic other) {
    ...
    public void copyNotNullProperty(VSuperviseBasic other) {
