...
public class EmailMessageSenderImpl implements MessageSender {
    ...
    private static final Log log = LogFactory
            .getLog(EmailMessageSenderImpl.class);
    ...
    public static boolean sendEmailMessage(String mailTo, String mailFrom,
            String msgSubject, String msgContent) {

        MultiPartEmail multMail = new MultiPartEmail();

        // SMTP
        multMail.setHostName(CodeRepositoryUtil
                .getValue("SysMail", "host_name"));
        ...
        try {
            // multMail.setFrom(CodeRepositoryUtil.getValue("SysMail",
            // "admin_email"));
