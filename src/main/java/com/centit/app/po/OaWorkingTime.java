...
public class OaWorkingTime implements java.io.Serializable {
    ...
    /** minimal constructor */
    public OaWorkingTime(String worktype, String worktypename,
            String hasschedule1, String hasschedule2, String hasschedule3,
            String hasschedule4, String automatch) {
    ...
    /** full constructor */
    public OaWorkingTime(String worktype, String worktypename,
            String hasschedule1, String schedule1begin, String schedule1end,
            String hasschedule2, String schedule2begin, String schedule2end,
            String hasschedule3, String schedule3begin, String schedule3end,
            String hasschedule4, String schedule4begin, String schedule4end,
            String automatch, String matchbeginday, String matchendday,
            String worktypedesc) {
