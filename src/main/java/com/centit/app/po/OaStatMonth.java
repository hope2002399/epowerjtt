...
public class OaStatMonth implements java.io.Serializable {
    ...
    /** minimal constructor */
    public OaStatMonth(String yearMonth, Date beginDay, Date eendDay) {
    ...
    /** full constructor */
    public OaStatMonth(String yearMonth, Date beginDay, String beginSchedule,
            Date eendDay, String endSchedule) {
